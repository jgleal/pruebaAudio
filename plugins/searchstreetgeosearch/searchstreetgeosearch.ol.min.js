...
goog.dom.classlist.swap=function(a,b,c){return goog.dom.classlist.contains(a,b)?(goog.dom.classlist.remove(a,b),goog.dom.classlist.add(a,c),!0):!1};goog.dom.classlist.toggle=function(a,b){var c=!goog.dom.classlist.contains(a,b);goog.dom.classlist.enable(a,b,c);return c};goog.dom.classlist.addRemove=function(a,b,c){goog.dom.classlist.remove(a,b);goog.dom.classlist.add(a,c)};var P={plugin:{}};P.plugin.Autocomplete={};
(function(){M.plugin.Autocomplete=function(a){a=a||{};this.map_=null;this.locality_="";M.utils.isNullOrEmpty(a.locality)||(this.locality_=a.locality);this.url_=M.config.SEARCHSTREET_URLCODINEAUTOCOMPLETE;this.minLength_=M.config.AUTOCOMPLETE_MINLENGTH;this.target_=a.target;this.resultsContainer_=a.html.querySelector("div#m-autocomplete-results");this.delayTime_=M.config.AUTOCOMPLETE_DELAYTIME;this.timeoutKey_=null;this.limit_=M.config.AUTOCOMPLETE_LIMIT;this.searchTime_=0;this.busqMunicipioClick_=
this.busqMunicipio_=!1;this.searchingResult_=this.resultsContainer_.querySelector("div#m-autocomplete-results > div#m-searching-result-autocomplete");M.Plugin.call(this)};goog.inherits(M.plugin.Autocomplete,M.Plugin);M.plugin.Autocomplete.prototype.addTo=function(a){this.map_=a;goog.dom.classlist.add(this.target_,M.plugin.Autocomplete.CLASS);goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_);goog.events.listen(this.target_,goog.events.EventType.INPUT,this.keyPress_,!1,this);goog.events.listen(this.target_,
goog.events.EventType.KEYUP,this.hiddenAutocomplete_,!1,this)};M.plugin.Autocomplete.prototype.hiddenAutocomplete_=function(a){27===a.keyCode&&this.cancelSearch_(a)};M.plugin.Autocomplete.prototype.keyPress_=function(a){a.preventDefault();M.utils.isNullOrEmpty(this.timeoutKey_)||this.cancelSearch_(a);var b=this.target_.value.trim();b.length>=this.minLength_&&(this.timeoutKey_=setTimeout(goog.bind(function(){-1!=b.indexOf(",")?this.busqMunicipio_=!0:this.busqMunicipioClick_=this.busqMunicipio_=!1;
this.search_(b)},this),this.delayTime_))};M.plugin.Autocomplete.prototype.search_=function(a,b){var c=this;this.evt=b;var d;d=M.utils.addParameters(this.url_,{input:a.trim(),limit:this.limit_,codine:this.locality_});d=this.formatContent_(d," ","%20");this.searchTime_=Date.now();(function(b){M.remote.get(d).then(function(d){if(b===c.searchTime_){d=JSON.parse(d.text);d=c.parseResultsForTemplate_(d);var e=c.map_.getControls();if(M.utils.isUndefined(d.docs)){d=0;for(var f=e.length;d<f;d++)"searchstreet"===
e[d].name_?e[d].completed=!1:"searchstreetgeosearch"===e[d].name_&&(e[d].ctrlSearchstreet.completed=!1)}else if(M.utils.isUndefined(d.docs[0]))for(d=0,f=e.length;d<f;d++)"searchstreet"===e[d].name_?e[d].completed=!1:"searchstreetgeosearch"===e[d].name_&&(e[d].ctrlSearchstreet.completed=!1);else M.template.compile(M.plugin.Autocomplete.RESULTAUTOCOMPLETE,{jsonp:!0,vars:d}).then(function(b){c.resultsContainer_.innerHTML=b.innerHTML;c.addEvents_(c.resultsContainer_.querySelectorAll("div.autocomplete"));
if(!0===c.busqMunicipio_)if(!0===c.busqMunicipioClick_){if(c.target_.value=a.slice(0,-1),c.resultsContainer_.innerHTML="",!M.utils.isUndefined(c.evt)){b=0;for(var d=e.length;b<d;b++)"searchstreetgeosearch"===e[b].name_?(e[b].ctrlSearchstreet.searchClick_(c.evt),e[b].ctrlSearchstreet.completed=!1,e[b].ctrlGeosearch.searchClick_(c.evt)):"searchstreet"===e[b].name_&&(e[b].searchClick_(c.evt),e[b].completed=!1);c.busqMunicipioClick_=!1}}else{b=c.resultsContainer_.querySelectorAll("div.autocomplete");
for(var d=0,f=e.length;d<f;d++)if("searchstreetgeosearch"===e[d].name_)if(!0===e[d].ctrlSearchstreet.completed)e[d].ctrlSearchstreet.completed=!1,c.resultsContainer_.innerHTML="";else for(var g=0,h=b.length;g<h;g++)c.evtClickMunicipaly_(b[g]);else if("searchstreet"===e[d].name_)if(!0===e[d].completed)e[d].completed=!1,c.resultsContainer_.innerHTML="";else for(g=0,h=b.length;g<h;g++)c.evtClickMunicipaly_(b[g])}else for(b=0,d=e.length;b<d;b++)"searchstreet"===e[b].name_?!0===e[b].completed&&(c.resultsContainer_.innerHTML=
"",e[b].completed=!1):"searchstreetgeosearch"===e[b].name_&&!0===e[b].ctrlSearchstreet.completed&&(c.resultsContainer_.innerHTML="",e[b].ctrlSearchstreet.completed=!1)});goog.dom.classlist.remove(c.resultsContainer_,M.plugin.Autocomplete.MINIMUM);goog.dom.removeChildren(c.resultsContainer_,c.searchingResult_)}})})(this.searchTime_)};M.plugin.Autocomplete.prototype.evtClickMunicipaly_=function(a){var b=this;goog.events.listen(a,goog.events.EventType.CLICK,function(a){b.clickMunicipaly_()},!1,this)};
M.plugin.Autocomplete.prototype.parseResultsForTemplate_=function(a){a=a.autocompletarDireccionMunicipioResponse.autocompletarDireccionMunicipioReturn.autocompletarDireccionMunicipioReturn;var b=[];if(!0===this.busqMunicipio_)if(M.utils.isUndefined(a))this.resultsContainer_.innerHTML="";else{!1===a instanceof Array&&(a=[a]);for(var c=0,d=a.length;c<d;c++){var e=a[c].split(",");b.push(e[0]+" "+e[1]+", "+e[3]+" ("+e[e.length-1]+")")}a=b}else if(!1===a instanceof Array){if(b.push(a),a=b,!M.utils.isUndefined(a[0]))for(b=
0,c=a.length;b<c;b++)a[b]=this.formatContent_(a[b],","," ")}else for(b=0,c=a.length;b<c;b++)a[b]=this.formatContent_(a[b],","," ");return{docs:a}};M.plugin.Autocomplete.prototype.addEvents_=function(a){for(var b=0,c=a.length;b<c;b++)this.addEventSearchMunicipality_(a[b])};M.plugin.Autocomplete.prototype.addEventSearchMunicipality_=function(a){goog.events.listen(a,goog.events.EventType.CLICK,function(b){this.searchMunicipality_(a.innerHTML,b)},!1,this)};M.plugin.Autocomplete.prototype.searchMunicipality_=
function(a,b){this.busqMunicipio_=!0;this.search_(a.trim()+",",b)};M.plugin.Autocomplete.prototype.clickMunicipaly_=function(){this.busqMunicipioClick_=!0};M.plugin.Autocomplete.prototype.formatContent_=function(a,b,c){return a.replace(new RegExp(b,"g"),c)};M.plugin.Autocomplete.prototype.cancelSearch_=function(a){clearTimeout(this.timeoutKey_);this.minLength_<=this.target_.value.length&&13!==a.keyCode&&27!==a.keyCode?(M.utils.isNullOrEmpty(this.resultsContainer_.parentElement.querySelector("#m-searchstreet-results>div"))?
goog.dom.classlist.add(this.resultsContainer_,"results-panel"):(goog.dom.classlist.add(this.resultsContainer_,"results-panel-content"),goog.dom.classlist.remove(this.resultsContainer_,"results-panel")),goog.dom.appendChild(this.resultsContainer_,this.searchingResult_),goog.dom.classlist.add(this.resultsContainer_.parentElement,M.plugin.Autocomplete.SEARCHING_CLASS),goog.dom.classlist.add(this.resultsContainer_,M.plugin.Autocomplete.MINIMUM)):(this.searchTime_=0,goog.dom.classlist.remove(this.resultsContainer_.parentElement,
M.plugin.Autocomplete.SEARCHING_CLASS),goog.dom.classlist.remove(this.resultsContainer_,M.plugin.Autocomplete.MINIMUM),goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_),this.resultsContainer_.innerHTML="")};M.plugin.Autocomplete.prototype.destroy=function(){this.map_.removeControls(this);this.map_=null;this.locality_="";this.searchingResult_=this.busqMunicipioClick_=this.busqMunicipio_=this.searchTime_=this.limit_=this.timeoutKey_=this.delayTime_=this.resultsContainer_=this.target_=
this.minLength_=this.url_=null};M.plugin.Autocomplete.CLASS="m-plugin-autocomplete";M.plugin.Autocomplete.SEARCHING_CLASS="m-searching";M.plugin.Autocomplete.RESULTAUTOCOMPLETE="resultautocomplete.html";M.plugin.Autocomplete.MINIMUM="minimum"})();goog.debug.entryPointRegistry={};goog.debug.EntryPointMonitor=function(){};goog.debug.entryPointRegistry.refList_=[];goog.debug.entryPointRegistry.monitors_=[];goog.debug.entryPointRegistry.monitorsMayExist_=!1;goog.debug.entryPointRegistry.register=function(a){goog.debug.entryPointRegistry.refList_[goog.debug.entryPointRegistry.refList_.length]=a;if(goog.debug.entryPointRegistry.monitorsMayExist_)for(var b=goog.debug.entryPointRegistry.monitors_,c=0;c<b.length;c++)a(goog.bind(b[c].wrap,b[c]))};
...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};P.control={};P.control.Geosearch={};
...
(function(){M.impl.layer.Geosearch=function(a,b){this.wktFormatter_=new ol.format.WKT;this.popup_=null;this.selectedFeatures_=[];this.name="geosearch";M.utils.isNullOrEmpty(a)||(this.name=a);M.impl.Layer.call(this,b)};goog.inherits(M.impl.layer.Geosearch,M.impl.Layer);M.impl.layer.Geosearch.prototype.addTo=function(a){this.map=a;this.ol3Layer=new ol.layer.Vector({source:new ol.source.Vector({useSpatialIndex:!1}),zIndex:M.impl.Map.Z_INDEX[M.layer.type.WFS]+999});!1!==this.options.visibility&&this.setVisible(this.inRange());
this.map.getMapImpl().addLayer(this.ol3Layer)};M.impl.layer.Geosearch.prototype.drawResults=function(a){var b=ol.proj.get(this.map.getProjection().code),c=[];M.utils.isNullOrEmpty(a.spatial_response)||(c=a.spatial_response.docs);M.utils.isNullOrEmpty(c)&&(c=a.response.docs);a=c.map(function(a){var c=this.wktFormatter_.readFeature(a.geom,{dataProjection:b});c.setId(a.solrid);c.setProperties(a);M.impl.layer.Geosearch.setStyleFeature_(c,M.style.state.DEFAULT);this.wrapComplexFeature_(c);return c},this);
this.ol3Layer.getSource().addFeatures(a)};M.impl.layer.Geosearch.prototype.drawNewResults=function(a){var b=ol.proj.get(this.map.getProjection().code),c;M.utils.isNullOrEmpty(a.spatial_response)?M.utils.isNullOrEmpty(a.response)||(c=a.response.docs):c=a.spatial_response.docs;a=c.map(function(a){var c=this.wktFormatter_.readFeature(a.geom,{dataProjection:b});c.setId(a.solrid);c.setProperties(a);M.impl.layer.Geosearch.setStyleFeature_(c,M.style.state.NEW);return c},this);this.ol3Layer.getSource().addFeatures(a)};
M.impl.layer.Geosearch.prototype.clear=function(a){this.map.removePopup();this.ol3Layer.getSource().clear()};M.impl.layer.Geosearch.prototype.selectFeatures=function(a,b,c){this.unselectFeatures();this.selectedFeatures_=a;M.impl.layer.Geosearch.setStyleFeature_(a,M.style.state.SELECTED);a=this.parseFeaturesForTemplate_(a);var d=this;M.template.compile(M.impl.layer.Geosearch.POPUP_RESULT,{jsonp:!0,vars:a,parseToHtml:!1}).then(function(a){a={icon:"g-cartografia-pin",title:"Geosearch",content:a};var e=
d.map.getPopup();M.utils.isNullOrEmpty(e)?(e=new M.Popup({panMapIfOutOfView:!c,ani:null}),e.addTab(a),d.map.addPopup(e,b)):e.addTab(a);e.on(M.evt.DESTROY,function(){this.internalUnselectFeatures_(!0)},d)})};M.impl.layer.Geosearch.prototype.selectFeatureBySolrid=function(a){a=this.ol3Layer.getSource().getFeatureById(a);this.selectedFeatures_=[a];var b=a.getGeometry(),c=M.impl.utils.getCentroidCoordinate(b);this.unselectFeatures();this.selectFeatures([a],c,!0);this.map.setBbox(b.getExtent())};M.impl.layer.Geosearch.prototype.parseFeaturesForTemplate_=
...
(function(){M.impl.control.Geosearch=function(a){a=a||{};this.helpHtml_=this.facadeMap_=null;this.layer_=new M.impl.layer.Geosearch(a.layerName)};goog.inherits(M.impl.control.Geosearch,M.impl.Control);M.impl.control.Geosearch.prototype.addTo=function(a,b){this.facadeMap_=a;this.layer_.addTo(a);a.getImpl().getFeaturesHandler().addLayer(this.layer_);ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.Geosearch.prototype.unselectResults=function(a){this.layer_.unselectFeatures(a)};
M.impl.control.Geosearch.prototype.setNewResultsAsDefault=function(){this.layer_.setNewResultsAsDefault()};M.impl.control.Geosearch.prototype.drawResults=function(a){this.layer_.drawResults(a)};M.impl.control.Geosearch.prototype.drawNewResults=function(a){this.layer_.drawNewResults(a)};M.impl.control.Geosearch.prototype.zoomToResults=function(){var a=ol.extent.boundingExtent(this.layer_.getOL3Layer().getSource().getFeatures().map(function(a){return ol.extent.getCenter(a.getGeometry().getExtent())}));
this.facadeMap_.setBbox(a)};M.impl.control.Geosearch.prototype.getLayer=function(){return this.layer_};M.impl.control.Geosearch.prototype.resultClick=function(a){this.layer_.selectFeatureBySolrid(a)};M.impl.control.Geosearch.prototype.hideHelp=function(){M.utils.isNullOrEmpty(this.helpHtml_)||(this.facadeMap_.getMapImpl().getTargetElement().removeChild(this.helpHtml_),this.helpHtml_=null)};M.impl.control.Geosearch.prototype.showHelp=function(a){var b=this.facadeMap_.getMapImpl().getTargetElement();
M.utils.isNullOrEmpty(this.helpHtml_)||b.removeChild(this.helpHtml_);this.helpHtml_=a;b.appendChild(this.helpHtml_)};M.impl.control.Geosearch.prototype.clear=function(){this.layer_.clear()};M.impl.control.Geosearch.prototype.destroy=function(){this.clear();goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.facadeMap_.getMapImpl().removeControl(this);this.layer_=this.helpHtml_=this.facadeMap_=null}})();P.control.Searchstreet={};
...
{jsonp:!0}).then(function(c){b.addEvents(c);a(c)})})};M.control.Searchstreet.prototype.addEvents=function(a){var b=this;this.element_=a;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-searchstreet-search-input"];this.button_=this.element_.getElementsByTagName("button")["m-searchstreet-search-btn"];this.clear_=this.element_.getElementsByTagName("button")["m-searchstreet-clear-btn"];goog.events.listen(this.input_,
goog.events.EventType.KEYUP,this.searchClick_,!1,this);goog.events.listen(this.button_,goog.events.EventType.CLICK,this.searchClick_,!1,this);goog.events.listen(this.clear_,goog.events.EventType.CLICK,this.clearSearchs_,!1,this);this.resultsContainer_=this.element_.getElementsByTagName("div")["m-searchstreet-results"];this.resultsAutocomplete_=this.element_.getElementsByTagName("div")["m-autocomplete-results"];this.searchingResult_=this.element_.querySelector("div#m-searchstreet-results > div#m-searching-result-searchstreet");
M.utils.isUndefined(this.codIne_)||M.utils.isNullOrEmpty(this.codIne_)||(a=M.utils.addParameters(this.searchCodIne_,{codigo:this.codIne_}),M.remote.get(a).then(function(a){var c;try{M.utils.isNullOrEmpty(a.text)||(c=JSON.parse(a.text),M.utils.isNullOrEmpty(c.comprobarCodIneResponse.comprobarCodIneReturn)?M.dialog.error("El c\u00f3digo del municipio '"+b.codIne_+"' no es v\u00e1lido"):(b.getMunProv_(c),b.element_.getElementsByTagName("span").codIne.innerHTML="B\u00fasquedas en "+b.municipio_+"  ("+
b.provincia_+")"))}catch(e){M.exception("La respuesta no es un JSON v\u00e1lido: "+e)}}));goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_)};M.control.Searchstreet.prototype.getMunProv_=function(a){this.provincia_=a.comprobarCodIneResponse.comprobarCodIneReturn.comprobarCodIneReturn.nombreProvincia;this.municipio_=a.comprobarCodIneResponse.comprobarCodIneReturn.comprobarCodIneReturn.nombreMunicipio};M.control.Searchstreet.prototype.searchClick_=function(a){a.preventDefault();if(a.type!==
goog.events.EventType.KEYUP||13===a.keyCode)if(goog.dom.classlist.remove(this.resultsAutocomplete_,M.control.Searchstreet.MINIMUM),goog.dom.removeChildren(this.resultsAutocomplete_,this.resultsAutocomplete_.querySelector("div#m-searching-result-autocomplete")),a=this.input_.value,M.utils.isNullOrEmpty(a))M.dialog.error("Debe introducir una b\u00fasqueda.");else if(this.completed=a.length<this.minAutocomplete_?!1:!0,M.utils.isUndefined(this.codIne_)||M.utils.isNullOrEmpty(this.codIne_))this.search_(a,
this.showResults_);else{var b=a.indexOf(",");-1<a.indexOf(",")&&(a=a.substring(0,b));this.search_(a+", "+this.municipio_+" ("+this.provincia_+")",this.showResults_)}};M.control.Searchstreet.prototype.search_=function(a,b){var c=this,d=null;this.municipio_=this.provincia_=null;goog.dom.appendChild(this.resultsContainer_,this.searchingResult_);goog.dom.classlist.add(this.element_,M.control.Searchstreet.SEARCHING_CLASS);goog.dom.classlist.add(this.resultsContainer_,M.control.Searchstreet.MINIMUM);a=
M.utils.addParameters(M.config.SEARCHSTREET_NORMALIZAR,{cadena:a});M.remote.get(a).then(function(a){a=JSON.parse(a.text).normalizarResponse.normalizarReturn;c.provincia_=M.utils.beautifyString(a.provincia);c.municipio_=M.utils.beautifyString(a.municipio);if(M.utils.isNullOrEmpty(c.provincia_))if(M.utils.isNullOrEmpty(c.provincia_)&&!M.utils.isNullOrEmpty(c.municipio_)){c.searchTime_=Date.now();c.respuestasProvincias_=[];for(var e=c.contadorProvincias=0,g=c.provincias_.length;e<g;e++)d=M.utils.addParameters(c.searchUrl_,
{streetname:a.nombreVia,streetNumber:a.numeroPortal,streetType:a.tipoVia,municipio:c.municipio_,provincia:c.provincias_[e],srs:c.facadeMap_.getProjection().code}),c.querySearchProvinces(d,c.provincias_[e],b)}else d=M.utils.addParameters(c.searchUrl_,{streetname:a.direccionSinNormalizar,streetNumber:null,streetType:null,municipio:null,provincia:null,srs:c.facadeMap_.getProjection().code}),c.searchTime_=Date.now(),c.querySearch_(d,null,b);else d=M.utils.addParameters(c.searchUrl_,{streetname:a.nombreVia,
streetNumber:a.numeroPortal,streetType:a.tipoVia,municipio:c.municipio_,provincia:c.provincia_,srs:c.facadeMap_.getProjection().code}),c.searchTime_=Date.now(),c.querySearch_(d,c.provincia_,b)})};M.control.Searchstreet.prototype.querySearch_=function(a,b,c){var d=this;(function(e){M.remote.get(a).then(function(a){if(e===d.searchTime_){var f;try{f=M.utils.isNullOrEmpty(a.text)||-1!=a.text.indexOf("No se ha podido obtener el codigoINE")?null:JSON.parse(a.text)}catch(h){M.exception("La respuesta no es un JSON v\u00e1lido: "+
h)}M.utils.isNullOrEmpty(f)||(d.provincia_=M.utils.beautifyString(b));c.call(d,f);goog.dom.classlist.remove(d.element_,M.control.Searchstreet.SEARCHING_CLASS);goog.dom.classlist.remove(d.resultsContainer_,M.control.Searchstreet.MINIMUM)}})})(this.searchTime_)};M.control.Searchstreet.prototype.querySearchProvinces=function(a,b,c){var d=this;(function(e){M.remote.get(a).then(function(a){d.respuestasProvincias_.push(a);d.contadorProvincias++;if(8==d.contadorProvincias){a=0;for(var f=d.respuestasProvincias_.length;a<
f;a++)if(e===d.searchTime_){var h;try{var k=d.respuestasProvincias_[a].text;h=M.utils.isNullOrEmpty(k)||-1!=k.indexOf("No se ha podido obtener el codigoINE")?null:JSON.parse(k)}catch(l){M.exception("La respuesta no es un JSON v\u00e1lido: "+l)}M.utils.isNullOrEmpty(h)||0===h.geocoderMunProvSrsResponse.geocoderMunProvSrsReturn.geocoderMunProvSrsReturn.coordinateX||(d.provincia_=M.utils.beautifyString(b),c.call(d,h),goog.dom.classlist.remove(d.element_,M.control.Searchstreet.SEARCHING_CLASS),goog.dom.classlist.remove(d.resultsContainer_,
M.control.Searchstreet.MINIMUM))}}})})(this.searchTime_)};M.control.Searchstreet.prototype.showResults_=function(a){var b=this,c=this.parseResultsForTemplate_(a);if(!M.utils.isUndefined(this.codIne_)){a=0;for(var d=c.docs.length;a<d;a++)M.utils.isUndefined(c.docs[a])||void 0!==c.docs[a].coordinateX||(c.docs.splice(a,1),d--,a--)}M.template.compile(M.control.Searchstreet.RESULTS_TEMPLATE,{jsonp:!0,vars:c}).then(function(a){goog.dom.classlist.remove(b.resultsContainer_,M.control.Searchstreet.HIDDEN_RESULTS_CLASS);
...
stroke:new ol.style.Stroke({color:"#fff",width:2})})})),b.setGeometry(new ol.geom.Point([a[c].coordinateX,a[c].coordinateY])),this.facadeMap_.getImpl().drawFeatures([b]),this.addEventClickFeature(a[c],b),this.listPoints.push([b]);this.zoomResults()};M.impl.control.Searchstreet.prototype.zoomResults=function(){var a=this.facadeMap_.getImpl().getDrawLayer().getOL3Layer().getSource().getFeatures(),a=ol.extent.boundingExtent(a.filter(function(a){return!M.utils.isNullOrEmpty(a.getGeometry())}).map(function(a){return a.getGeometry().getFirstCoordinate()}));
this.facadeMap_.setBbox(a)};M.impl.control.Searchstreet.prototype.addEventClickFeature=function(a,b){this.facadeMap_.removePopup();var c=this;M.utils.isNullOrEmpty(b)?(this.showPopup_(a,!1),this.facadeMap_.setBbox([a.coordinateX,a.coordinateY,a.coordinateX,a.coordinateY])):b.click=function(b){c.showPopup_(a)}};M.impl.control.Searchstreet.prototype.showPopup_=function(a,b){var c=this;M.template.compile(M.impl.control.Searchstreet.POPUP_TEMPLATE,{jsonp:!0,vars:{tVia:a.streetType,nVia:a.streetName,num:a.streetNumber,
mun:a.localityName,prov:a.cityName},parseToHtml:!1}).then(function(d){d={icon:"g-cartografia-zoom",title:"Searchstreet",content:d};c.popup_=c.facadeMap_.getPopup();M.utils.isNullOrEmpty(c.popup_)?(M.utils.isUndefined(b)?c.popup_=new M.Popup:c.popup_=new M.Popup({panMapIfOutOfView:b}),c.popup_.addTab(d),c.facadeMap_.addPopup(c.popup_,[a.coordinateX,a.coordinateY])):c.popup_.getTabs().some(function(a){return"Searchstreet"!==a.title})?c.popup_.addTab(d):(c.facadeMap_.removePopup(),M.utils.isUndefined(b)?
c.popup_=new M.Popup:c.popup_=new M.Popup({panMapIfOutOfView:b}),c.popup_.addTab(d),c.facadeMap_.addPopup(c.popup_,[a.coordinateX,a.coordinateY]))})};M.impl.control.Searchstreet.prototype.getElement=function(){return this.element_};M.impl.control.Searchstreet.prototype.removePoints_=function(){for(var a=0,b=this.listPoints.length;a<b;a++)this.facadeMap_.getImpl().removeFeatures(this.listPoints[a]);this.listPoints=[]};M.impl.control.Searchstreet.prototype.destroy=function(){goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],
"top-extra");this.removePoints_();this.facadeMap_.getMapImpl().removeControl(this);this.facadeMap_.getImpl().removePopup();this.element_=this.listPoints=this.facadeMap_=null};M.impl.control.Searchstreet.POPUP_TEMPLATE="searchstreetpopup.html"})();P.impl.control.GeosearchIntegrated={};(function(){M.impl.control.GeosearchIntegrated=function(){M.impl.control.Geosearch.call(this)};goog.inherits(M.impl.control.GeosearchIntegrated,M.impl.control.Geosearch);M.impl.control.GeosearchIntegrated.prototype.addTo=function(a,b){this.facadeMap_=a;this.layer_.addTo(a);a.getImpl().getFeaturesHandler().addLayer(this.layer_);ol.control.Control.call(this,{element:b,target:null})};M.impl.control.GeosearchIntegrated.prototype.zoomToResults=function(){}})();P.control.GeosearchIntegrated={};
...
function(a){this.element_=a;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-searchstreetgeosearch-search-input"];goog.events.listen(this.input_,goog.events.EventType.KEYUP,this.searchClick_,!1,this);a=this.element_.getElementsByTagName("button")["m-searchstreetgeosearch-search-btn"];goog.events.listen(a,goog.events.EventType.CLICK,this.searchClick_,!1,this);var b=this.element_.getElementsByTagName("button")["m-searchstreetgeosearch-help-btn"];
goog.events.listen(b,goog.events.EventType.CLICK,function(a){a.preventDefault();goog.dom.classlist.toggle(b,"shown");this.helpClick_()},!1,this);this.resultsContainer_=this.element_.getElementsByTagName("div")["m-geosearch-results"];M.utils.enableTouchScroll(this.resultsContainer_);this.searchingResult_=this.element_.querySelector("div#m-geosearch-results > div#m-searching-result-geosearch");goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_)};M.control.GeosearchIntegrated.prototype.appendResults_=
function(a){this.drawNewResults(a);var b=this.parseResultsForTemplate_(a,!0),c=this;M.template.compile(M.control.Geosearch.RESULTS_TEMPLATE,{jsonp:!0,vars:b}).then(function(b){b=b.getElementsByTagName("div")["m-geosearch-results-scroll"].children;for(var d;null!==(d=b.item(0));)c.resultsScrollContainer_.appendChild(d),goog.events.listen(d,goog.events.EventType.CLICK,c.resultClick_,!1,c);c.resultsContainer_.getElementsByTagName("span")["m-geosearch-page-found"].innerHTML=c.results_.length;goog.dom.classlist.remove(c.element_,
M.control.Geosearch.SEARCHING_CLASS);c.resultsContainer_.removeChild(c.searchingResult_);c.checkScrollSearch_(a)})};M.control.GeosearchIntegrated.prototype.resultsClick_=function(a){goog.dom.classlist.toggle(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra-search");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-arriba");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-abajo");goog.dom.classlist.toggle(this.resultsContainer_,"hidden");M.utils.isNullOrEmpty(this.resultsContainer_.parentElement.querySelector("div#m-searchstreet-results.hidden"))&&
goog.dom.classlist.toggle(this.resultsContainer_.parentElement,"hidden")};M.control.GeosearchIntegrated.prototype.getImpl=function(a){return this.impl}})();P.plugin.SearchstreetGeosearch={};
...
position:M.ui.position.TL,tooltip:"Buscador de calles y geob\u00fasquedas"});this.panel_.addControls(this.control_);this.map_.addPanels(this.panel_)};M.plugin.SearchstreetGeosearch.prototype.destroy=function(){this.map_.removeControls([this.control_]);this.locality_=this.control_=this.map_=this.parameters_=this.name=null}})();P.impl.control.SearchstreetIntegrated={};(function(){M.impl.control.SearchstreetIntegrated=function(){M.impl.control.Searchstreet.call(this)};goog.inherits(M.impl.control.SearchstreetIntegrated,M.impl.control.Searchstreet);M.impl.control.SearchstreetIntegrated.prototype.addTo=function(a,b){this.facadeMap_=a;this.element_=b;ol.control.Control.call(this,{element:b,target:null})};M.impl.control.SearchstreetIntegrated.prototype.zoomResults=function(){}})();P.control.SearchstreetIntegrated={};
...
function(a){this.element_=a;var b=this;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-searchstreetgeosearch-search-input"];this.button_=this.element_.getElementsByTagName("button")["m-searchstreetgeosearch-search-btn"];this.clear_=this.element_.getElementsByTagName("button")["m-searchstreetgeosearch-clear-btn"];goog.events.listen(this.input_,goog.events.EventType.KEYUP,this.searchClick_,!1,this);goog.events.listen(this.button_,
goog.events.EventType.CLICK,this.searchClick_,!1,this);goog.events.listen(this.clear_,goog.events.EventType.CLICK,this.clearSearchs_,!1,this);this.resultsContainer_=this.element_.getElementsByTagName("div")["m-searchstreet-results"];this.resultsAutocomplete_=this.element_.getElementsByTagName("div")["m-autocomplete-results"];this.resultsGeosearch_=this.element_.getElementsByTagName("div")["m-geosearch-results"];this.searchingResult_=this.element_.querySelector("div#m-searchstreet-results > div#m-searching-result-searchstreet");
if(!M.utils.isUndefined(this.codIne_)){this.searchTime_=Date.now();var c=M.utils.addParameters(this.searchCodIne_,{codigo:this.codIne_});(function(a){M.remote.get(c).then(function(a){var c;try{M.utils.isNullOrEmpty(a.text)||(c=JSON.parse(a.text),M.utils.isNullOrEmpty(c.comprobarCodIneResponse.comprobarCodIneReturn)?M.dialog.error("El c\u00f3digo del municipio '"+b.codIne_+"' no es v\u00e1lido"):(b.getMunProv_(c),b.element_.getElementsByTagName("span").codIne.innerHTML="B\u00fasquedas en "+b.municipio_+
"  ("+b.provincia_+")"))}catch(g){M.exception("La respuesta no es un JSON v\u00e1lido: "+g)}})})(this.searchTime_)}goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_)};M.control.SearchstreetIntegrated.prototype.clearSearchs_=function(){goog.dom.classlist.remove(this.element_,"shown");for(var a=this.facadeMap_.getControls(),b=0,c=a.length;b<c;b++)"searchstreetgeosearch"===a[b].name_&&a[b].ctrlGeosearch.getImpl().layer_.ol3Layer.getSource().clear();this.facadeMap_.removePopup();this.getImpl().removePoints_();
this.input_.value="";this.resultsContainer_.innerHTML="";this.resultsAutocomplete_.innerHTML="";this.resultsGeosearch_.innerHTML=""};M.control.SearchstreetIntegrated.prototype.searchClick_=function(a){a.preventDefault();if(a.type!==goog.events.EventType.KEYUP||13===a.keyCode)if(goog.dom.classlist.remove(this.resultsAutocomplete_,M.control.Searchstreet.MINIMUM),goog.dom.removeChildren(this.resultsAutocomplete_,this.resultsAutocomplete_.querySelector("div#m-searching-result-autocomplete")),a=this.input_.value,
!M.utils.isNullOrEmpty(a))if(this.completed=a.length<this.minAutocomplete_?!1:!0,M.utils.isUndefined(this.codIne_)||M.utils.isNullOrEmpty(this.codIne_))this.search_(a,this.showResults_);else{var b=a.indexOf(",");-1<a.indexOf(",")&&(a=a.substring(0,b));this.search_(a+", "+this.municipio_+" ("+this.provincia_+")",this.showResults_)}};M.control.SearchstreetIntegrated.prototype.resultsClick_=function(a){goog.dom.classlist.add(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],
"top-extra-searchs");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-arriba");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-abajo");goog.dom.classlist.toggle(this.resultsContainer_,"hidden");M.utils.isNullOrEmpty(this.resultsContainer_.parentElement.querySelector("div#m-geosearch-results.hidden"))&&goog.dom.classlist.toggle(this.resultsContainer_.parentElement,"hidden")};M.control.SearchstreetIntegrated.prototype.getImpl=function(){return this.impl}})();P.control.SearchstreetGeosearch={};
...
this.facadeMap_.getImpl().getDrawLayer().getOL3Layer().getSource().getFeatures().concat(this.facadeMap_.getControls("searchstreetgeosearch")[0].ctrlGeosearch.getImpl().getLayer().getOL3Layer().getSource().getFeatures());M.utils.isNullOrEmpty(a)||(a=ol.extent.boundingExtent(a.map(function(a){return ol.extent.getCenter(a.getGeometry().getExtent())})),this.facadeMap_.setBbox(a))};M.impl.control.SearchstreetGeosearch.prototype.destroy=function(){goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],
"top-extra");this.facadeMap_.getMapImpl().removeControl(this);this.facadeMap_.getImpl().removePopup();this.element_=this.facadeMap_=null}})();goog.exportSymbol("M.control.GeosearchIntegrated",M.control.GeosearchIntegrated);goog.exportProperty(M.control.GeosearchIntegrated.prototype,"createView",M.control.GeosearchIntegrated.prototype.createView);goog.exportProperty(M.control.GeosearchIntegrated.prototype,"addEvents",M.control.GeosearchIntegrated.prototype.addEvents);goog.exportProperty(M.control.GeosearchIntegrated.prototype,"getImpl",M.control.GeosearchIntegrated.prototype.getImpl);goog.exportSymbol("M.plugin.SearchstreetGeosearch",M.plugin.SearchstreetGeosearch);
goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"name",M.plugin.SearchstreetGeosearch.prototype.name);goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"addTo",M.plugin.SearchstreetGeosearch.prototype.addTo);goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"destroy",M.plugin.SearchstreetGeosearch.prototype.destroy);goog.exportSymbol("M.control.SearchstreetGeosearch",M.control.SearchstreetGeosearch);
