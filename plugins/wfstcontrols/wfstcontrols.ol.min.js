...
goog.array.concatMap=function(a,b,c){return goog.array.concat.apply([],goog.array.map(a,b,c))};goog.debug.entryPointRegistry={};goog.debug.EntryPointMonitor=function(){};goog.debug.entryPointRegistry.refList_=[];goog.debug.entryPointRegistry.monitors_=[];goog.debug.entryPointRegistry.monitorsMayExist_=!1;goog.debug.entryPointRegistry.register=function(a){goog.debug.entryPointRegistry.refList_[goog.debug.entryPointRegistry.refList_.length]=a;if(goog.debug.entryPointRegistry.monitorsMayExist_)for(var b=goog.debug.entryPointRegistry.monitors_,c=0;c<b.length;c++)a(goog.bind(b[c].wrap,b[c]))};
...
M.utils.isNullOrEmpty(this.savefeature_)||a.push(this.savefeature_),M.utils.isNullOrEmpty(this.editattibute_)||a.push(this.editattibute_),this.clearfeature_.getImpl().clear(),a.forEach(function(a){a.setLayer(b)}))};P.impl={};P.impl.control={};P.impl.control.ClearFeature={};
...
(function(){M.impl.control.DeleteFeature=function(a){this.layer_=a;this.modifiedFeatures=[];M.impl.Control.call(this,a)};goog.inherits(M.impl.control.DeleteFeature,M.impl.Control);M.impl.control.DeleteFeature.prototype.activate=function(){this.layer_.getImpl().on(M.evt.SELECT_FEATURES,this.removeFeature_,this)};M.impl.control.DeleteFeature.prototype.deactivate=function(){this.layer_.getImpl().un(M.evt.SELECT_FEATURES,this.removeFeature_,this)};M.impl.control.DeleteFeature.prototype.removeFeature_=function(a,
b){a=a[0];this.layer_.getImpl().getOL3Layer().getSource().removeFeature(a);M.utils.isNullOrEmpty(a.getId())?(b=this.facadeMap_.getControls("drawfeature")[0],M.utils.isNullOrEmpty(b)||(b=b.getImpl().modifiedFeatures,a=b.indexOf(a),b.splice(a,1))):this.modifiedFeatures.push(a)}})();P.impl.control.DrawFeature={};
(function(){M.impl.control.DrawFeature=function(a){M.impl.control.WFSTBase.call(this,a)};goog.inherits(M.impl.control.DrawFeature,M.impl.control.WFSTBase);M.impl.control.DrawFeature.prototype.createInteraction_=function(){var a=this.layer_.getImpl(),b=a.getOL3Layer();this.interaction_=new ol.interaction.Draw({source:b.getSource(),type:M.geom.parseWFS(this.layer_.geometry),style:b.getStyle()});this.interaction_.on("drawend",function(a){this.modifiedFeatures.push(a.feature)},this);a.on(M.evt.LOAD,this.updateLayerFeatures_,
this)};M.impl.control.DrawFeature.prototype.updateLayerFeatures_=function(){this.facadeMap_.getMapImpl().removeInteraction(this.interaction_);this.interaction_=null}})();P.impl.control.EditAttribute={};
(function(){M.impl.control.EditAttribute=function(a){this.layer_=a;this.editFeature=null;M.impl.Control.call(this)};goog.inherits(M.impl.control.EditAttribute,M.impl.Control);M.impl.control.EditAttribute.prototype.activate=function(){var a=this.layer_.getImpl();a.on(M.evt.SELECT_FEATURES,this.showEditPopup_,this);a.on(M.evt.UNSELECT_FEATURES,this.unselectFeature_,this)};M.impl.control.EditAttribute.prototype.deactivate=function(){var a=this.layer_.getImpl();a.un(M.evt.SELECT_FEATURES,this.showEditPopup_,
this);a.un(M.evt.UNSELECT_FEATURES,this.unselectFeature_,this)};M.impl.control.EditAttribute.prototype.showEditPopup_=function(a,b){this.editFeature=a[0];if(M.utils.isNullOrEmpty(this.editFeature.getId()))this.editFeature=null,M.dialog.info("Debe guardar el elemento previamente");else{this.editFeature.setStyle(M.impl.control.EditAttribute.SELECTED_STYLE);var c={properties:[]};Object.keys(this.editFeature.getProperties()).filter(function(a){return"geometry"!==a}).forEach(function(a){c.properties.push({key:a,
value:this.editFeature.get(a)})},this);var d=this;M.template.compile(M.control.EditAttribute.TEMPLATE_POPUP,{jsonp:!0,vars:c,parseToHtml:!1}).then(function(a){a={icon:"g-cartografia-texto",title:M.control.EditAttribute.POPUP_TITLE,content:a};d.popup_=d.facadeMap_.getPopup();M.utils.isNullOrEmpty(d.popup_)?(d.popup_=new M.Popup,d.popup_.addTab(a),d.facadeMap_.addPopup(d.popup_,b)):d.popup_.getTabs().some(function(a){return a.title!==M.control.EditAttribute.POPUP_TITLE})?d.popup_.addTab(a):(d.facadeMap_.removePopup(),
d.popup_=new M.Popup,d.popup_.addTab(a),d.facadeMap_.addPopup(d.popup_,b));d.popup_.on(M.evt.SHOW,function(){var a=this.popup_.getContent().querySelector("button#m-button-editattributeSave");M.utils.isNullOrEmpty(a)||goog.events.listen(a,goog.events.EventType.CLICK,this.saveAttributes_,!1,this)},d);d.popup_.on(M.evt.DESTROY,function(){var a=this.popup_.getContent().querySelector("button#m-button-editattributeSave");M.utils.isNullOrEmpty(a)||goog.events.unlisten(a,goog.events.EventType.CLICK,this.saveAttributes_,
!1,this);this.unselectFeature_()},d)})}};M.impl.control.EditAttribute.prototype.saveAttributes_=function(a){this.editFeature.unset("bbox",!0);var b=this.popup_.getContent(),c=a.target;a=this.editFeature.getProperties();goog.dom.classes.add(c,"m-savefeature-saving");Object.keys(a).forEach(function(a){if(null!==b.querySelector("input#"+a)){var c=b.querySelector("input#"+a).value;this.editFeature.set(a,c,!0)}},this);this.layer_.getImpl().getDescribeFeatureType().then(function(a){var b=this.editFeature.getGeometryName(),
...
"m-savefeature-saving");200===a.code?M.dialog.success("Se ha guardado correctamente el elemento"):M.dialog.error("Ha ocurrido un error al guardar: ".concat(a.text))})}.bind(this))};M.impl.control.EditAttribute.prototype.unselectFeature_=function(){null!==this.editFeature&&(this.editFeature.setStyle(M.impl.layer.WFS.STYLE),this.editFeature=null,this.facadeMap_.removePopup())};M.impl.control.EditAttribute.prototype.destroy=function(){M.impl.control.EditAttribute.superClass_.destroy.call(this);this.facadeMap_.removePopup()};
M.impl.control.EditAttribute.SELECTED_STYLE=new ol.style.Style({fill:new ol.style.Fill({color:"rgba(175, 127, 19, 0.2)"}),stroke:new ol.style.Stroke({color:"#af7f13",width:2}),image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"#af7f13"})})})})();P.impl.control.ModifyFeature={};
...
this.modify=null};M.impl.control.ModifyFeature.prototype.createInteractionModify_=function(){var a=this.facadeMap_.getMapImpl(),b=this.layer_.getImpl(),c=b.getOL3Layer(),d=new ol.Collection(c.getSource().getFeatures());d.forEach(function(a){a.on("change",function(a){this.currentFeature_=a.target},this)},this);this.modify=new ol.interaction.Modify({features:d,deleteCondition:function(a){return ol.events.condition.shiftKeyOnly(a)&&ol.events.condition.singleClick(a)},style:c.getStyle()});this.modify.on("modifyend",
function(a){a=this.modifiedFeatures.indexOf(this.currentFeature_);0<=a?this.modifiedFeatures[a]=this.currentFeature_:this.modifiedFeatures.push(this.currentFeature_);this.currentFeature_=null},this);a.addInteraction(this.modify);b.on(M.evt.LOAD,this.updateLayerFeatures_,this)};M.impl.control.ModifyFeature.prototype.updateLayerFeatures_=function(){this.facadeMap_.getMapImpl().removeInteraction(this.modify);this.modify=null};M.impl.control.ModifyFeature.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);
this.modify=this.layer_=null;this.modifiedFeatures=[]}})();goog.dom.xml={};goog.dom.xml.MAX_XML_SIZE_KB=2048;goog.dom.xml.MAX_ELEMENT_DEPTH=256;goog.dom.xml.hasActiveXObjectSupport_=function(){if(!goog.userAgent.IE)return!1;try{return new ActiveXObject("MSXML2.DOMDocument"),!0}catch(a){return!1}};goog.dom.xml.ACTIVEX_SUPPORT=goog.userAgent.IE&&goog.dom.xml.hasActiveXObjectSupport_();
...
goog.exportProperty(M.impl.control.DrawFeature.prototype,"createInteraction_",M.impl.control.DrawFeature.prototype.createInteraction_);goog.exportSymbol("M.control.EditAttribute",M.control.EditAttribute);goog.exportProperty(M.control.EditAttribute.prototype,"createView",M.control.EditAttribute.prototype.createView);goog.exportProperty(M.control.EditAttribute.prototype,"getActivationButton",M.control.EditAttribute.prototype.getActivationButton);
goog.exportProperty(M.control.EditAttribute.prototype,"equals",M.control.EditAttribute.prototype.equals);goog.exportProperty(M.control.EditAttribute.prototype,"setLayer",M.control.EditAttribute.prototype.setLayer);goog.exportSymbol("M.control.EditAttribute.NAME",M.control.EditAttribute.NAME);goog.exportSymbol("M.control.EditAttribute.POPUP_TITLE",M.control.EditAttribute.POPUP_TITLE);goog.exportSymbol("M.control.EditAttribute.TEMPLATE",M.control.EditAttribute.TEMPLATE);
goog.exportSymbol("M.control.EditAttribute.TEMPLATE_POPUP",M.control.EditAttribute.TEMPLATE_POPUP);goog.exportSymbol("M.impl.control.EditAttribute",M.impl.control.EditAttribute);goog.exportProperty(M.impl.control.EditAttribute.prototype,"editFeature",M.impl.control.EditAttribute.prototype.editFeature);goog.exportProperty(M.impl.control.EditAttribute.prototype,"activate",M.impl.control.EditAttribute.prototype.activate);goog.exportProperty(M.impl.control.EditAttribute.prototype,"deactivate",M.impl.control.EditAttribute.prototype.deactivate);
goog.exportProperty(M.impl.control.EditAttribute.prototype,"saveAttributes_",M.impl.control.EditAttribute.prototype.saveAttributes_);goog.exportProperty(M.impl.control.EditAttribute.prototype,"unselectFeature_",M.impl.control.EditAttribute.prototype.unselectFeature_);goog.exportProperty(M.impl.control.EditAttribute.prototype,"destroy",M.impl.control.EditAttribute.prototype.destroy);goog.exportSymbol("M.impl.control.EditAttribute.SELECTED_STYLE",M.impl.control.EditAttribute.SELECTED_STYLE);
goog.exportSymbol("M.control.ModifyFeature",M.control.ModifyFeature);goog.exportProperty(M.control.ModifyFeature.prototype,"createView",M.control.ModifyFeature.prototype.createView);goog.exportProperty(M.control.ModifyFeature.prototype,"getActivationButton",M.control.ModifyFeature.prototype.getActivationButton);goog.exportProperty(M.control.ModifyFeature.prototype,"equals",M.control.ModifyFeature.prototype.equals);goog.exportProperty(M.control.ModifyFeature.prototype,"setLayer",M.control.ModifyFeature.prototype.setLayer);
goog.exportSymbol("M.control.ModifyFeature.NAME",M.control.ModifyFeature.NAME);goog.exportSymbol("M.control.ModifyFeature.TEMPLATE",M.control.ModifyFeature.TEMPLATE);goog.exportSymbol("M.impl.control.ModifyFeature",M.impl.control.ModifyFeature);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"modify",M.impl.control.ModifyFeature.prototype.modify);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"modifiedFeatures",M.impl.control.ModifyFeature.prototype.modifiedFeatures);
goog.exportProperty(M.impl.control.ModifyFeature.prototype,"activate",M.impl.control.ModifyFeature.prototype.activate);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"deactivate",M.impl.control.ModifyFeature.prototype.deactivate);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"destroy",M.impl.control.ModifyFeature.prototype.destroy);goog.exportSymbol("M.control.SaveFeature",M.control.SaveFeature);goog.exportProperty(M.control.SaveFeature.prototype,"createView",M.control.SaveFeature.prototype.createView);
goog.exportProperty(M.control.SaveFeature.prototype,"equals",M.control.SaveFeature.prototype.equals);goog.exportProperty(M.control.SaveFeature.prototype,"manageActivation",M.control.SaveFeature.prototype.manageActivation);goog.exportProperty(M.control.SaveFeature.prototype,"saveFeature_",M.control.SaveFeature.prototype.saveFeature_);goog.exportProperty(M.control.SaveFeature.prototype,"setLayer",M.control.SaveFeature.prototype.setLayer);goog.exportSymbol("M.control.SaveFeature.NAME",M.control.SaveFeature.NAME);
goog.exportSymbol("M.control.SaveFeature.TEMPLATE",M.control.SaveFeature.TEMPLATE);goog.exportSymbol("M.impl.control.SaveFeature",M.impl.control.SaveFeature);goog.exportProperty(M.impl.control.SaveFeature.prototype,"addTo",M.impl.control.SaveFeature.prototype.addTo);goog.exportProperty(M.impl.control.SaveFeature.prototype,"saveFeature",M.impl.control.SaveFeature.prototype.saveFeature);goog.exportProperty(M.impl.control.SaveFeature.prototype,"destroy",M.impl.control.SaveFeature.prototype.destroy);
...
goog.exportProperty(M.impl.control.DrawFeature.prototype,"deactivate",M.impl.control.DrawFeature.prototype.deactivate);goog.exportProperty(M.impl.control.DrawFeature.prototype,"destroy",M.impl.control.DrawFeature.prototype.destroy); })(window.M);
