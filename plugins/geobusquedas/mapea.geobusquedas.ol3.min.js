...
goog.asserts.getType_=function(a){return a instanceof Function?a.displayName||a.name||"unknown type name":a instanceof Object?a.constructor.displayName||a.constructor.name||Object.prototype.toString.call(a):null===a?"null":typeof a};goog.array={};goog.NATIVE_ARRAY_PROTOTYPES=goog.TRUSTED_SITE;goog.array.ASSUME_NATIVE_FUNCTIONS=!0;goog.array.peek=function(a){return a[a.length-1]};goog.array.last=goog.array.peek;goog.array.ARRAY_PROTOTYPE_=Array.prototype;
...
(function(){M.control.Geobusquedas=function(a,b,c,d){M.utils.isUndefined(M.impl.control.Geobusquedas)&&M.exception("La implementaci\u00f3n usada no puede crear controles Geobusquedas");this.searchingResult_=this.resultsScrollContainer_=this.resultsContainer_=this.element_=this.input_=null;this.searchTime_=0;this.url_=a;this.core_=b;this.handler_=c;this.searchUrl_=M.utils.concatUrlPaths([this.url_,this.core_,this.handler_]);this.helpUrl_=M.utils.concatUrlPaths([this.url_,this.core_,"/help"]);this.searchParameters_=
d;M.utils.isNullOrEmpty(this.searchParameters_)||(this.searchUrl_=M.utils.addParameters(this.searchUrl_,this.searchParameters_));this.results_=[];this.helpShown_=!1;this.scrollIsUp_=!0;a=new M.impl.control.Geobusquedas;M.Control.call(this,a,M.control.Geobusquedas.NAME)};goog.inherits(M.control.Geobusquedas,M.Control);M.control.Geobusquedas.prototype.createView=function(a){var b=this;return new Promise(function(a,d){M.template.compile(M.control.Geobusquedas.TEMPLATE).then(function(d){b.addEvents(d);
a(d)})})};M.control.Geobusquedas.prototype.addEvents=function(a){this.element_=a;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-geobusquedas-search-input"];goog.events.listen(this.input_,goog.events.EventType.KEYUP,this.searchClick_,!1,this);a=this.element_.getElementsByTagName("button")["m-geobusquedas-search-btn"];goog.events.listen(a,goog.events.EventType.CLICK,this.searchClick_,!1,this);var b=this.element_.getElementsByTagName("button")["m-geobusquedas-help-btn"];
goog.events.listen(b,goog.events.EventType.CLICK,function(a){a.preventDefault();goog.dom.classlist.toggle(b,"shown");this.helpClick_()},!1,this);a=this.element_.getElementsByTagName("button")["m-geobusquedas-clear-btn"];goog.events.listen(a,goog.events.EventType.CLICK,this.clearClick_,!1,this);this.resultsContainer_=this.element_.querySelector("div#m-geobusquedas-results");M.utils.enableTouchScroll(this.resultsContainer_);this.searchingResult_=this.element_.querySelector("div#m-geobusquedas-results > div#m-searching-result")};
M.control.Geobusquedas.prototype.searchClick_=function(a){a.preventDefault();if(a.type!==goog.events.EventType.KEYUP||13===a.keyCode)this.results_.length=0,a=this.input_.value,M.utils.isNullOrEmpty(a)?M.dialog.info("Debe introducir una b\u00fasqueda."):this.search_(a,this.showResults_)};M.control.Geobusquedas.prototype.resultClick_=function(a){a.preventDefault();this.getImpl().facadeMap_.removePopup();a=a.currentTarget.id;this.getImpl().resultClick(a)};M.control.Geobusquedas.prototype.search_=function(a,
b){goog.dom.classlist.remove(this.element_,"shown");goog.dom.appendChild(this.resultsContainer_,this.searchingResult_);this.searchTime_=Date.now();goog.dom.classlist.add(this.element_,M.control.Geobusquedas.SEARCHING_CLASS);var c=M.utils.addParameters(this.searchUrl_,{q:a,start:this.results_.length}),d=this;(function(a){M.remote.get(c).then(function(c){if(a===d.searchTime_){var g;try{g=JSON.parse(c.text)}catch(h){M.exception("La respuesta no es un JSON v\u00e1lido: "+h)}b.call(d,g);goog.dom.classlist.remove(d.element_,
M.control.Geobusquedas.SEARCHING_CLASS)}})})(this.searchTime_)};M.control.Geobusquedas.prototype.showResults_=function(a){this.getImpl().clear();this.drawResults(a);a=this.parseResultsForTemplate_(a);var b=this;M.template.compile(M.control.Geobusquedas.RESULTS_TEMPLATE,a).then(function(a){M.utils.isNullOrEmpty(b.resultsScrollContainer_)||goog.events.unlisten(b.resultsScrollContainer_,goog.events.EventType.SCROLL,b.resultsScroll_,!1,b);for(var d=b.resultsContainer_.querySelectorAll(".result"),e,f=
0,g=d.length;f<g;f++)e=d.item(f),goog.events.unlisten(e,goog.events.EventType.CLICK,b.resultClick_,!1,b);d=b.resultsContainer_.querySelector("div.page > div.g-cartografia-flecha-arriba");M.utils.isNullOrEmpty(d)||goog.events.unlisten(d,goog.events.EventType.CLICK,b.resultsClick_,!1,b);b.resultsContainer_.innerHTML=a.innerHTML;b.resultsScrollContainer_=b.resultsContainer_.querySelector("div#m-geobusquedas-results-scroll");M.utils.enableTouchScroll(b.resultsScrollContainer_);goog.events.listen(b.resultsScrollContainer_,
goog.events.EventType.SCROLL,b.resultsScroll_,!1,b);d=b.resultsContainer_.getElementsByClassName("result");f=0;for(g=d.length;f<g;f++)e=d.item(f),goog.events.listen(e,goog.events.EventType.CLICK,b.resultClick_,!1,b);d=b.resultsContainer_.querySelector("div.page > div.g-cartografia-flecha-arriba");goog.events.listen(d,goog.events.EventType.CLICK,b.resultsClick_,!1,b);b.fire(M.evt.COMPLETED)})};M.control.Geobusquedas.prototype.drawResults=function(a){this.getImpl().drawResults(a)};M.control.Geobusquedas.prototype.drawNewResults=
function(a){this.getImpl().drawNewResults(a)};M.control.Geobusquedas.prototype.getInput=function(){return this.input_};M.control.Geobusquedas.prototype.appendResults_=function(a){this.drawNewResults(a);a=this.parseResultsForTemplate_(a,!0);var b=this;M.template.compile(M.control.Geobusquedas.RESULTS_TEMPLATE,a).then(function(a){a=a.getElementsByTagName("div")["m-geobusquedas-results-scroll"].children;for(var d;null!==(d=a.item(0));)b.resultsScrollContainer_.appendChild(d),goog.events.listen(d,goog.events.EventType.CLICK,
b.resultClick_,!1,b);b.resultsContainer_.getElementsByTagName("span")["m-geobusquedas-page-found"].innerHTML=b.results_.length})};M.control.Geobusquedas.prototype.resultsScroll_=function(a){a=a.target;var b=goog.style.getSize(a).height;(a=15>=a.scrollHeight-a.scrollTop-b)&&this.scrollIsUp_?(this.scrollIsUp_=!1,this.scrollSearch_()):a||(this.scrollIsUp_=!0)};M.control.Geobusquedas.prototype.scrollSearch_=function(){this.getImpl().unselectResults(!0);this.getImpl().setNewResultsAsDefault();this.search_(this.input_.value,
this.appendResults_)};M.control.Geobusquedas.prototype.helpClick_=function(a){if(!0===this.helpShown_)this.getImpl().hideHelp(),this.helpShown_=!1;else{var b=this;M.remote.get(this.helpUrl_).then(function(a){var d;try{d=JSON.parse(a.text)}catch(e){M.exception("La respuesta no es un JSON v\u00e1lido: "+e)}M.template.compile(M.control.Geobusquedas.HELP_TEMPLATE,{entities:d}).then(function(a){b.getImpl().showHelp(a);b.helpShown_=!0})})}};M.control.Geobusquedas.prototype.clearClick_=function(a){goog.dom.classlist.remove(this.element_,
"shown");M.utils.isNullOrEmpty(this.input_)||(this.input_.value="");M.utils.isNullOrEmpty(this.resultsContainer_)||(this.resultsContainer_.innerHTML="");M.utils.isNullOrEmpty(this.resultsScrollContainer_)||(this.resultsScrollContainer_.innerHTML="",this.resultsScrollContainer_=null);this.results_.length=0;goog.dom.classlist.remove(this.resultsContainer_,M.control.Geobusquedas.HIDDEN_RESULTS_CLASS);this.getImpl().clear()};M.control.Geobusquedas.prototype.resultsClick_=function(a){goog.dom.classlist.toggle(a.target,
"g-cartografia-flecha-arriba");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-abajo");goog.dom.classlist.toggle(this.resultsContainer_,M.control.Geobusquedas.HIDDEN_RESULTS_CLASS)};M.control.Geobusquedas.prototype.equals=function(a){var b=!1;a instanceof M.control.Geobusquedas&&(b=this.name===a.name);return b};M.control.Geobusquedas.prototype.destroy=function(){this.getImpl().destroy();this.impl=this.template_=null};M.control.Geobusquedas.prototype.parseResultsForTemplate_=function(a,b){var c=
...
var c=["geom","_version_","keywords","solrid"];return b=b.map(function(a){var b=[],f;for(f in a)M.utils.includes(c,f)||b.push({key:M.utils.beautifyAttributeName(f),value:a[f]});return{solrid:a.solrid,attributes:b}})};M.control.Geobusquedas.NAME="geobusquedas";M.control.Geobusquedas.TEMPLATE="geobusquedas.html";M.control.Geobusquedas.RESULTS_TEMPLATE="geobusquedasresults.html";M.control.Geobusquedas.HELP_TEMPLATE="geobusquedashelp.html";M.control.Geobusquedas.SEARCHING_CLASS="searching";M.control.Geobusquedas.HIDDEN_RESULTS_CLASS=
"hidden"})();P.plugin={};P.plugin.Geobusquedas={};
(function(){M.plugin.Geobusquedas=function(a){a=a||{};this.panel_=this.control_=this.map_=null;this.url_=M.config.GEOSEARCH_URL;M.utils.isNullOrEmpty(a.url)||(this.url_=a.url);this.core_=M.config.GEOSEARCH_CORE;M.utils.isNullOrEmpty(a.core)||(this.core_=a.core);this.handler_=M.config.GEOSEARCH_HANDLER;M.utils.isNullOrEmpty(a.handler)||(this.handler_=a.handler);this.searchParameters_=a.params||{};M.Plugin.call(this)};goog.inherits(M.plugin.Geobusquedas,M.Plugin);M.plugin.Geobusquedas.prototype.addTo=
function(a){this.map_=a;if(M.utils.isNullOrEmpty(this.searchParameters_)||M.utils.isNullOrEmpty(this.searchParameters_.srs))this.searchParameters_.srs=this.map_.getProjection().code;this.control_=new M.control.Geobusquedas(this.url_,this.core_,this.handler_,this.searchParameters_);this.control_.on(M.evt.ADD_TO_MAP,this.onLoadCallback_,this);this.panel_=new M.ui.Panel("geobusquedas",{collapsible:!0,className:"m-geobusquedas",collapsedButtonClass:"g-cartografia-zoom",position:M.ui.position.TL});this.panel_.addControls(this.control_);
this.map_.addPanels(this.panel_)};M.plugin.Geobusquedas.prototype.getInput=function(){var a=null;M.utils.isNullOrEmpty(this.control_)||(a=this.control_.getInput());return a};M.plugin.Geobusquedas.prototype.destroy=function(){this.map_.removeControls(this.control_);this.map_=null}})();P.impl={};P.impl.utils={};P.impl.utils.Geobusquedas={};
...
(function(){var a={image:new ol.style.Icon({src:M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24.svg"])})},b={fill:new ol.style.Fill({color:"#A15BD7"}),stroke:new ol.style.Stroke({color:"#A15BD7",width:2})},c={image:new ol.style.Icon({src:M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24.svg"])})};Geobusquedas.feature.style.DEFAULT={};Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POINT]=new ol.style.Style(a);Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.MULTI_POINT]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POINT];
Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.LINE_STRING]=new ol.style.Style(b);Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.LINEAR_RING]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.MULTI_LINE_STRING]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POLYGON]=new ol.style.Style(c);Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.MULTI_POLYGON]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POLYGON];
Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.CIRCLE]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.GEOMETRY_COLLECTION]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POLYGON];a={image:new ol.style.Icon({src:M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24-new.svg"])})};b={fill:new ol.style.Fill({color:"#e2951b"}),stroke:new ol.style.Stroke({color:"#e2951b",width:2})};c={image:new ol.style.Icon({src:M.utils.concatUrlPaths([M.config.THEME_URL,
"/img/m-pin-24-new.svg"])})};Geobusquedas.feature.style.NEW={};Geobusquedas.feature.style.NEW[M.geom.wkt.type.POINT]=new ol.style.Style(a);Geobusquedas.feature.style.NEW[M.geom.wkt.type.MULTI_POINT]=Geobusquedas.feature.style.NEW[M.geom.wkt.type.POINT];Geobusquedas.feature.style.NEW[M.geom.wkt.type.LINE_STRING]=new ol.style.Style(b);Geobusquedas.feature.style.NEW[M.geom.wkt.type.LINEAR_RING]=Geobusquedas.feature.style.NEW[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.NEW[M.geom.wkt.type.MULTI_LINE_STRING]=
...
"/img/m-pin-24-sel.svg"])})};b={fill:new ol.style.Fill({color:"#fcfcfc"}),stroke:new ol.style.Stroke({color:"#3589d1",width:2})};c={fill:new ol.style.Fill({color:"rgba(252, 252, 252, 0.2)"}),stroke:new ol.style.Stroke({color:"#3589d1",width:2})};Geobusquedas.feature.style.SELECTED={};Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POINT]=new ol.style.Style(a);Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.MULTI_POINT]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POINT];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.LINE_STRING]=
new ol.style.Style(b);Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.LINEAR_RING]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.MULTI_LINE_STRING]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POLYGON]=new ol.style.Style(c);Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.MULTI_POLYGON]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.CIRCLE]=
Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.GEOMETRY_COLLECTION]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POLYGON]})();P.impl.layer={};P.impl.layer.Geobusquedas={};
(function(){M.impl.layer.Geobusquedas=function(a,b){this.wktFormatter_=new ol.format.WKT;this.popup_=null;this.selectedFeatures_=[];this.name="geobusquedas";M.utils.isNullOrEmpty(a)||(this.name=a);M.impl.Layer.call(this,b)};goog.inherits(M.impl.layer.Geobusquedas,M.impl.Layer);M.impl.layer.Geobusquedas.prototype.addTo=function(a){this.map=a;this.ol3Layer=new ol.layer.Vector({source:new ol.source.Vector({useSpatialIndex:!1}),zIndex:M.impl.Map.Z_INDEX[M.layer.type.WFS]+999});!1!==this.options.visibility&&
this.setVisible(this.inRange());this.map.getMapImpl().addLayer(this.ol3Layer)};M.impl.layer.Geobusquedas.prototype.drawResults=function(a){var b=ol.proj.get(this.map.getProjection().code),c=[];M.utils.isNullOrEmpty(a.spatial_response)||(c=a.spatial_response.docs);M.utils.isNullOrEmpty(c)&&(c=a.response.docs);a=c.map(function(a){var c=this.wktFormatter_.readFeature(a.geom,{dataProjection:b});c.setId(a.solrid);c.setProperties(a);M.impl.layer.Geobusquedas.setStyleFeature_(c,M.style.state.DEFAULT);this.wrapComplexFeature_(c);
return c},this);this.ol3Layer.getSource().addFeatures(a)};M.impl.layer.Geobusquedas.prototype.drawNewResults=function(a){var b=ol.proj.get(this.map.getProjection().code),c;M.utils.isNullOrEmpty(a.spatial_response)?M.utils.isNullOrEmpty(a.response)||(c=a.response.docs):c=a.spatial_response.docs;a=c.map(function(a){var c=this.wktFormatter_.readFeature(a.geom,{dataProjection:b});c.setId(a.solrid);c.setProperties(a);M.impl.layer.Geobusquedas.setStyleFeature_(c,M.style.state.NEW);return c},this);this.ol3Layer.getSource().addFeatures(a)};
M.impl.layer.Geobusquedas.prototype.clear=function(a){this.map.removePopup();this.ol3Layer.getSource().clear()};M.impl.layer.Geobusquedas.prototype.selectFeatures=function(a,b,c){this.selectedFeatures_=a;M.impl.layer.Geobusquedas.setStyleFeature_(a,M.style.state.SELECTED);a=this.parseFeaturesForTemplate_(a);var d=this;M.template.compile(M.impl.layer.Geobusquedas.POPUP_RESULT,a,!1).then(function(a){a={icon:"g-cartografia-zoom",title:"Geobusquedas",content:a};var f=d.map.getPopup();M.utils.isNullOrEmpty(f)?
(f=new M.Popup({panMapIfOutOfView:!c,ani:null}),f.addTab(a),d.map.addPopup(f,b)):f.addTab(a);f.on(M.evt.DESTROY,function(){this.unselectFeatures(!0)},d)})};M.impl.layer.Geobusquedas.prototype.selectFeatureBySolrid=function(a){a=this.ol3Layer.getSource().getFeatureById(a);this.selectedFeatures_=[a];var b=a.getGeometry(),c=M.impl.utils.getCentroidCoordinate(b);this.unselectFeatures();this.selectFeatures([a],c,!0);this.map.setBbox(b.getExtent())};M.impl.layer.Geobusquedas.prototype.parseFeaturesForTemplate_=
function(a){var b={features:[]};a.forEach(function(a){var d=["geom","_version_","keywords","solrid",a.getGeometryName()],e=a.getProperties(),f=[],g;for(g in e)M.utils.includes(d,g.toLowerCase())||f.push({key:M.utils.beautifyAttributeName(g),value:e[g]});a={solrid:a.getId(),attributes:f};b.features.push(a)});return b};M.impl.layer.Geobusquedas.prototype.wrapComplexFeature_=function(a){var b=a.getGeometry();if(b.getType()===M.geom.wkt.type.POLYGON||b.getType()===M.geom.wkt.type.MULTI_POLYGON){var c;
c=b.getType()===M.geom.wkt.type.POLYGON?b.getInteriorPoint():b.getInteriorPoints();b=new ol.geom.GeometryCollection([c,b]);a.setGeometry(b)}};M.impl.layer.Geobusquedas.prototype.unselectFeatures=function(a){M.impl.layer.Geobusquedas.setStyleFeature_(this.selectedFeatures_,M.style.state.DEFAULT);this.selectedFeatures_.length=0;a||this.map.removePopup()};M.impl.layer.Geobusquedas.prototype.setNewResultsAsDefault=function(){M.impl.layer.Geobusquedas.setStyleFeature_(this.getOL3Layer().getSource().getFeatures(),
M.style.state.DEFAULT)};M.impl.layer.Geobusquedas.prototype.destroy=function(){var a=this.map.getMapImpl();M.utils.isNullOrEmpty(this.ol3Layer)||(a.removeLayer(this.ol3Layer),this.ol3Layer=null);this.map=null};M.impl.layer.Geobusquedas.prototype.equals=function(a){var b=!1;a instanceof M.impl.layer.Geobusquedas&&(b=(b=this.url===a.url)&&this.name===a.name);return b};M.impl.layer.Geobusquedas.setStyleFeature_=function(a,b){M.utils.isArray(a)||(a=[a]);a.forEach(function(a){var d=a.getGeometry().getType();
M.utils.isNullOrEmpty(b)||b===M.style.state.DEFAULT?a.setStyle(Geobusquedas.feature.style.DEFAULT[d]):b===M.style.state.NEW?a.setStyle(Geobusquedas.feature.style.NEW[d]):b===M.style.state.SELECTED&&a.setStyle(Geobusquedas.feature.style.SELECTED[d])})};M.impl.layer.Geobusquedas.POPUP_RESULT="geobusquedasfeaturepopup.html"})();goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);goog.dom.classes.set(a,c.join(" "));return c.length==e};
...
(function(){M.impl.control.Geobusquedas=function(a){a=a||{};this.helpHtml_=this.facadeMap_=null;this.layer_=new M.impl.layer.Geobusquedas(a.layerName)};goog.inherits(M.impl.control.Geobusquedas,M.impl.Control);M.impl.control.Geobusquedas.prototype.addTo=function(a,b){this.facadeMap_=a;this.layer_.addTo(a);a.getImpl().getFeaturesHandler().addLayer(this.layer_);ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.Geobusquedas.prototype.unselectResults=function(a){this.layer_.unselectFeatures(a)};
M.impl.control.Geobusquedas.prototype.setNewResultsAsDefault=function(){this.layer_.setNewResultsAsDefault()};M.impl.control.Geobusquedas.prototype.drawResults=function(a){this.layer_.drawResults(a)};M.impl.control.Geobusquedas.prototype.drawNewResults=function(a){this.layer_.drawNewResults(a)};M.impl.control.Geobusquedas.prototype.resultClick=function(a){this.layer_.selectFeatureBySolrid(a)};M.impl.control.Geobusquedas.prototype.hideHelp=function(){M.utils.isNullOrEmpty(this.helpHtml_)||(this.facadeMap_.getMapImpl().getTargetElement().removeChild(this.helpHtml_),
this.helpHtml_=null)};M.impl.control.Geobusquedas.prototype.showHelp=function(a){var b=this.facadeMap_.getMapImpl().getTargetElement();M.utils.isNullOrEmpty(this.helpHtml_)||b.removeChild(this.helpHtml_);this.helpHtml_=a;b.appendChild(this.helpHtml_)};M.impl.control.Geobusquedas.prototype.clear=function(){this.layer_.clear()};M.impl.control.Geobusquedas.prototype.destroy=function(){this.facadeMap_.removeControl(this);this.facadeMap_=null}})();goog.exportSymbol("M.plugin.Geobusquedas",M.plugin.Geobusquedas);goog.exportProperty(M.plugin.Geobusquedas.prototype,"addTo",M.plugin.Geobusquedas.prototype.addTo);goog.exportProperty(M.plugin.Geobusquedas.prototype,"getInput",M.plugin.Geobusquedas.prototype.getInput);goog.exportProperty(M.plugin.Geobusquedas.prototype,"destroy",M.plugin.Geobusquedas.prototype.destroy);goog.exportSymbol("M.impl.control.Geobusquedas",M.impl.control.Geobusquedas);
goog.exportProperty(M.impl.control.Geobusquedas.prototype,"addTo",M.impl.control.Geobusquedas.prototype.addTo);goog.exportProperty(M.impl.control.Geobusquedas.prototype,"unselectResults",M.impl.control.Geobusquedas.prototype.unselectResults);goog.exportProperty(M.impl.control.Geobusquedas.prototype,"setNewResultsAsDefault",M.impl.control.Geobusquedas.prototype.setNewResultsAsDefault);goog.exportProperty(M.impl.control.Geobusquedas.prototype,"drawResults",M.impl.control.Geobusquedas.prototype.drawResults);
goog.exportProperty(M.impl.control.Geobusquedas.prototype,"drawNewResults",M.impl.control.Geobusquedas.prototype.drawNewResults);goog.exportProperty(M.impl.control.Geobusquedas.prototype,"resultClick",M.impl.control.Geobusquedas.prototype.resultClick);goog.exportProperty(M.impl.control.Geobusquedas.prototype,"hideHelp",M.impl.control.Geobusquedas.prototype.hideHelp);goog.exportProperty(M.impl.control.Geobusquedas.prototype,"showHelp",M.impl.control.Geobusquedas.prototype.showHelp);
goog.exportProperty(M.impl.control.Geobusquedas.prototype,"clear",M.impl.control.Geobusquedas.prototype.clear);goog.exportProperty(M.impl.control.Geobusquedas.prototype,"destroy",M.impl.control.Geobusquedas.prototype.destroy);goog.exportSymbol("M.control.Geobusquedas",M.control.Geobusquedas);goog.exportProperty(M.control.Geobusquedas.prototype,"createView",M.control.Geobusquedas.prototype.createView);goog.exportProperty(M.control.Geobusquedas.prototype,"addEvents",M.control.Geobusquedas.prototype.addEvents);
goog.exportProperty(M.control.Geobusquedas.prototype,"drawResults",M.control.Geobusquedas.prototype.drawResults);goog.exportProperty(M.control.Geobusquedas.prototype,"drawNewResults",M.control.Geobusquedas.prototype.drawNewResults);goog.exportProperty(M.control.Geobusquedas.prototype,"getInput",M.control.Geobusquedas.prototype.getInput);goog.exportProperty(M.control.Geobusquedas.prototype,"equals",M.control.Geobusquedas.prototype.equals);
goog.exportProperty(M.control.Geobusquedas.prototype,"destroy",M.control.Geobusquedas.prototype.destroy);goog.exportSymbol("M.control.Geobusquedas.NAME",M.control.Geobusquedas.NAME);goog.exportSymbol("M.control.Geobusquedas.TEMPLATE",M.control.Geobusquedas.TEMPLATE);goog.exportSymbol("M.control.Geobusquedas.RESULTS_TEMPLATE",M.control.Geobusquedas.RESULTS_TEMPLATE);goog.exportSymbol("M.control.Geobusquedas.HELP_TEMPLATE",M.control.Geobusquedas.HELP_TEMPLATE);
goog.exportSymbol("M.control.Geobusquedas.SEARCHING_CLASS",M.control.Geobusquedas.SEARCHING_CLASS);goog.exportSymbol("M.control.Geobusquedas.HIDDEN_RESULTS_CLASS",M.control.Geobusquedas.HIDDEN_RESULTS_CLASS);goog.exportSymbol("M.impl.layer.Geobusquedas",M.impl.layer.Geobusquedas);goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"addTo",M.impl.layer.Geobusquedas.prototype.addTo);goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"drawResults",M.impl.layer.Geobusquedas.prototype.drawResults);
goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"drawNewResults",M.impl.layer.Geobusquedas.prototype.drawNewResults);goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"clear",M.impl.layer.Geobusquedas.prototype.clear);goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"selectFeatures",M.impl.layer.Geobusquedas.prototype.selectFeatures);goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"selectFeatureBySolrid",M.impl.layer.Geobusquedas.prototype.selectFeatureBySolrid);
goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"unselectFeatures",M.impl.layer.Geobusquedas.prototype.unselectFeatures);goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"setNewResultsAsDefault",M.impl.layer.Geobusquedas.prototype.setNewResultsAsDefault);goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"destroy",M.impl.layer.Geobusquedas.prototype.destroy);goog.exportProperty(M.impl.layer.Geobusquedas.prototype,"equals",M.impl.layer.Geobusquedas.prototype.equals);
goog.exportSymbol("M.impl.layer.Geobusquedas.POPUP_RESULT",M.impl.layer.Geobusquedas.POPUP_RESULT); })(window.M);
