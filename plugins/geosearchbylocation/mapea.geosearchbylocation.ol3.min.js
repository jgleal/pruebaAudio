...
goog.debug.entryPointRegistry.unmonitorAllIfPossible=function(a){var b=goog.debug.entryPointRegistry.monitors_;goog.asserts.assert(a==b[b.length-1],"Only the most recent monitor can be unwrapped.");a=goog.bind(a.unwrap,a);for(var c=0;c<goog.debug.entryPointRegistry.refList_.length;c++)goog.debug.entryPointRegistry.refList_[c](a);b.length--};goog.array={};goog.NATIVE_ARRAY_PROTOTYPES=goog.TRUSTED_SITE;goog.array.ASSUME_NATIVE_FUNCTIONS=!0;goog.array.peek=function(a){return a[a.length-1]};goog.array.last=goog.array.peek;goog.array.ARRAY_PROTOTYPE_=Array.prototype;
...
goog.object.setWithReturnValueIfNotSet=function(a,b,c){if(b in a)return a[b];c=c();return a[b]=c};goog.object.equals=function(a,b){for(var c in a)if(!(c in b)||a[c]!==b[c])return!1;for(c in b)if(!(c in a))return!1;return!0};goog.object.clone=function(a){var b={},c;for(c in a)b[c]=a[c];return b};goog.object.unsafeClone=function(a){var b=goog.typeOf(a);if("object"==b||"array"==b){if(goog.isFunction(a.clone))return a.clone();var b="array"==b?[]:{},c;for(c in a)b[c]=goog.object.unsafeClone(a[c]);return b}return a};
...
goog.userAgent.isDocumentMode=goog.userAgent.isDocumentModeOrHigher;goog.userAgent.DOCUMENT_MODE=function(){var a=goog.global.document,b=goog.userAgent.getDocumentMode_();return a&&goog.userAgent.IE?b||("CSS1Compat"==a.compatMode?parseInt(goog.userAgent.VERSION,10):5):void 0}();goog.events={};
...
DOMCHARACTERDATAMODIFIED:"DOMCharacterDataModified",BEFOREPRINT:"beforeprint",AFTERPRINT:"afterprint"};goog.reflect={};goog.reflect.object=function(a,b){return b};goog.reflect.sinkValue=function(a){goog.reflect.sinkValue[" "](a);return a};goog.reflect.sinkValue[" "]=goog.nullFunction;goog.reflect.canAccessProperty=function(a,b){try{return goog.reflect.sinkValue(a[b]),!0}catch(c){}return!1};goog.events.BrowserEvent=function(a,b){goog.events.Event.call(this,a?a.type:"");this.relatedTarget=this.currentTarget=this.target=null;this.charCode=this.keyCode=this.button=this.screenY=this.screenX=this.clientY=this.clientX=this.offsetY=this.offsetX=0;this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.state=null;this.platformModifierKey=!1;this.event_=null;a&&this.init(a,b)};goog.inherits(goog.events.BrowserEvent,goog.events.Event);
...
goog.dom.classlist.swap=function(a,b,c){return goog.dom.classlist.contains(a,b)?(goog.dom.classlist.remove(a,b),goog.dom.classlist.add(a,c),!0):!1};goog.dom.classlist.toggle=function(a,b){var c=!goog.dom.classlist.contains(a,b);goog.dom.classlist.enable(a,b,c);return c};goog.dom.classlist.addRemove=function(a,b,c){goog.dom.classlist.remove(a,b);goog.dom.classlist.add(a,c)};goog.dom.BrowserFeature={CAN_ADD_NAME_OR_TYPE_ATTRIBUTES:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),CAN_USE_CHILDREN_ATTRIBUTE:!goog.userAgent.GECKO&&!goog.userAgent.IE||goog.userAgent.IE&&goog.userAgent.isDocumentModeOrHigher(9)||goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.9.1"),CAN_USE_INNER_TEXT:goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("9"),CAN_USE_PARENT_ELEMENT_PROPERTY:goog.userAgent.IE||goog.userAgent.OPERA||goog.userAgent.WEBKIT,INNER_HTML_NEEDS_SCOPED_ELEMENT:goog.userAgent.IE,
...
goog.style.getClientPosition=function(a){goog.asserts.assert(a);if(a.nodeType==goog.dom.NodeType.ELEMENT)return goog.style.getClientPositionForElement_(a);a=a.changedTouches?a.changedTouches[0]:a;return new goog.math.Coordinate(a.clientX,a.clientY)};goog.style.setPageOffset=function(a,b,c){var d=goog.style.getPageOffset(a);b instanceof goog.math.Coordinate&&(c=b.y,b=b.x);goog.style.setPosition(a,a.offsetLeft+(b-d.x),a.offsetTop+(c-d.y))};
...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};var P={control:{}};P.control.Geobusquedas={};
(function(){M.control.Geobusquedas=function(a,b,c,d){M.utils.isUndefined(M.impl.control.Geobusquedas)&&M.exception("La implementaci\u00f3n usada no puede crear controles Geobusquedas");this.resultsScrollContainer_=this.resultsContainer_=this.element_=this.input_=null;this.searchTime_=0;this.url_=a;this.core_=b;this.handler_=c;this.searchUrl_=M.utils.concatUrlPaths([this.url_,this.core_,this.handler_]);this.helpUrl_=M.utils.concatUrlPaths([this.url_,this.core_,"/help"]);this.searchParameters_=d;M.utils.isNullOrEmpty(this.searchParameters_)||
(this.searchUrl_=M.utils.addParameters(this.searchUrl_,this.searchParameters_));this.results_=[];this.helpShown_=!1;this.scrollIsUp_=!0;a=new M.impl.control.Geobusquedas;M.Control.call(this,a)};goog.inherits(M.control.Geobusquedas,M.Control);M.control.Geobusquedas.prototype.createView=function(a){var b=this;return new Promise(function(a,d){M.template.compile(M.control.Geobusquedas.TEMPLATE).then(function(d){b.addEvents(d);a(d)})})};M.control.Geobusquedas.prototype.addEvents=function(a){this.element_=
a;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-geobusquedas-search-input"];goog.events.listen(this.input_,goog.events.EventType.KEYUP,this.searchClick_,!1,this);a=this.element_.getElementsByTagName("button")["m-geobusquedas-search-btn"];goog.events.listen(a,[goog.events.EventType.CLICK,goog.events.EventType.TOUCHEND],this.searchClick_,!1,this);var b=this.element_.getElementsByTagName("button")["m-geobusquedas-help-btn"];
goog.events.listen(b,[goog.events.EventType.CLICK,goog.events.EventType.TOUCHEND],function(a){a.preventDefault();goog.dom.classlist.toggle(b,"shown");this.helpClick_()},!1,this);a=this.element_.getElementsByTagName("button")["m-geobusquedas-clear-btn"];goog.events.listen(a,[goog.events.EventType.CLICK,goog.events.EventType.TOUCHEND],this.clearClick_,!1,this);a=this.element_.getElementsByTagName("button")["m-geobusquedas-results-btn"];goog.events.listen(a,[goog.events.EventType.CLICK,goog.events.EventType.TOUCHEND],
this.resultsClick_,!1,this);this.resultsContainer_=this.element_.getElementsByTagName("div")["m-geobusquedas-results"]};M.control.Geobusquedas.prototype.searchClick_=function(a){a.preventDefault();if(a.type!==goog.events.EventType.KEYUP||13===a.keyCode)this.results_.length=0,a=this.input_.value,M.utils.isNullOrEmpty(a)?M.dialog.error("Debe introducir una b\u00fasqueda."):this.search_(a,this.showResults_)};M.control.Geobusquedas.prototype.resultClick_=function(a){a.preventDefault();this.getImpl().facadeMap_.removePopup();
a=a.currentTarget.id;this.getImpl().resultClick(a)};M.control.Geobusquedas.prototype.search_=function(a,b){goog.dom.classlist.remove(this.element_,"shown");this.searchTime_=Date.now();goog.dom.classlist.add(this.element_,M.control.Geobusquedas.SEARCHING_CLASS);var c=M.utils.addParameters(this.searchUrl_,{q:a,start:this.results_.length}),d=this;(function(a){M.remote.get(c).then(function(c){if(a===d.searchTime_){var g;try{g=JSON.parse(c.text)}catch(h){M.exception("La respuesta no es un JSON v\u00e1lido: "+
h)}b.call(d,g);goog.dom.classlist.remove(d.element_,M.control.Geobusquedas.SEARCHING_CLASS)}})})(this.searchTime_)};M.control.Geobusquedas.prototype.showResults_=function(a){this.getImpl().clear();this.drawResults(a);a=this.parseResultsForTemplate_(a);var b=this;M.template.compile(M.control.Geobusquedas.RESULTS_TEMPLATE,a).then(function(a){b.resultsContainer_.innerHTML=a.innerHTML;M.utils.isNullOrEmpty(b.resultsScrollContainer_)||goog.events.unlisten(b.resultsScrollContainer_,goog.events.EventType.SCROLL,
b.resultsScroll_,!1,b);b.resultsScrollContainer_=b.resultsContainer_.getElementsByTagName("div")["m-geobusquedas-results-scroll"];goog.events.listen(b.resultsScrollContainer_,goog.events.EventType.SCROLL,b.resultsScroll_,!1,b);a=b.resultsContainer_.getElementsByClassName("result");for(var d=0,e=a.length;d<e;d++){var f=a.item(d);goog.events.listen(f,[goog.events.EventType.CLICK,goog.events.EventType.TOUCHEND],b.resultClick_,!1,b)}b.fire(M.evt.COMPLETED)})};M.control.Geobusquedas.prototype.drawResults=
function(a){this.getImpl().drawResults(a)};M.control.Geobusquedas.prototype.drawNewResults=function(a){this.getImpl().drawNewResults(a)};M.control.Geobusquedas.prototype.getInput=function(){return this.input_};M.control.Geobusquedas.prototype.appendResults_=function(a){this.drawNewResults(a);a=this.parseResultsForTemplate_(a,!0);var b=this;M.template.compile(M.control.Geobusquedas.RESULTS_TEMPLATE,a).then(function(a){a=a.getElementsByTagName("div")["m-geobusquedas-results-scroll"].children;for(var d;null!==
(d=a.item(0));)b.resultsScrollContainer_.appendChild(d),goog.events.listen(d,[goog.events.EventType.CLICK,goog.events.EventType.TOUCHEND],b.resultClick_,!1,b);b.resultsContainer_.getElementsByTagName("span")["m-geobusquedas-page-found"].innerHTML=b.results_.length})};M.control.Geobusquedas.prototype.resultsScroll_=function(a){a=a.target;var b=goog.style.getSize(a).height;(a=15>=a.scrollHeight-a.scrollTop-b)&&this.scrollIsUp_?(this.scrollIsUp_=!1,this.scrollSearch_()):a||(this.scrollIsUp_=!0)};M.control.Geobusquedas.prototype.scrollSearch_=
function(){this.search_(this.input_.value,this.appendResults_)};M.control.Geobusquedas.prototype.helpClick_=function(a){if(!0===this.helpShown_)this.getImpl().hideHelp(),this.helpShown_=!1;else{var b=this;M.remote.get(this.helpUrl_).then(function(a){var d;try{d=JSON.parse(a.text)}catch(e){M.exception("La respuesta no es un JSON v\u00e1lido: "+e)}M.template.compile(M.control.Geobusquedas.HELP_TEMPLATE,{entities:d}).then(function(a){b.getImpl().showHelp(a);b.helpShown_=!0})})}};M.control.Geobusquedas.prototype.clearClick_=
function(a){goog.dom.classlist.remove(this.element_,"shown");M.utils.isNullOrEmpty(this.input_)||(this.input_.value="");M.utils.isNullOrEmpty(this.resultsContainer_)||(this.resultsContainer_.innerHTML="");M.utils.isNullOrEmpty(this.resultsScrollContainer_)||(this.resultsScrollContainer_.innerHTML="",this.resultsScrollContainer_=null);this.results_.length=0;this.getImpl().clear()};M.control.Geobusquedas.prototype.resultsClick_=function(a){goog.dom.classlist.contains(this.resultsContainer_,M.control.Geobusquedas.HIDDEN_RESULTS_CLASS)?
goog.dom.classlist.remove(this.resultsContainer_,M.control.Geobusquedas.HIDDEN_RESULTS_CLASS):goog.dom.classlist.add(this.resultsContainer_,M.control.Geobusquedas.HIDDEN_RESULTS_CLASS)};M.control.Geobusquedas.prototype.equals=function(a){var b=!1;a instanceof M.control.Geobusquedas&&(b=this.name===a.name);return b};M.control.Geobusquedas.prototype.destroy=function(){this.getImpl().destroy();this.impl=this.template_=null};M.control.Geobusquedas.prototype.parseResultsForTemplate_=function(a,b){var c=
0;M.utils.isUndefined(a.spatial_response)||(c=a.spatial_response.numFound);0===c&&(c=a.response.numFound);var d=this.getDocsFromResults_(a);this.results_=!0===b?this.results_.concat(d):d;var e=!M.utils.isUndefined(a.spatial_response)&&M.utils.isNullOrEmpty(a.spatial_response.docs);return{docs:d,total:c,partial:e}};M.control.Geobusquedas.prototype.getDocsFromResults_=function(a){var b=[];M.utils.isNullOrEmpty(a.spatial_response)||(b=a.spatial_response.docs);M.utils.isNullOrEmpty(b)&&(b=a.response.docs);
var c=["geom","_version_","keywords","solrid"];return b=b.map(function(a){var b=[],f;for(f in a)M.utils.includes(c,f)||b.push({key:M.utils.beautifyAttributeName(f),value:a[f]});return{solrid:a.solrid,attributes:b}})};M.control.Geobusquedas.TEMPLATE="geobusquedas.html";M.control.Geobusquedas.RESULTS_TEMPLATE="geobusquedasresults.html";M.control.Geobusquedas.HELP_TEMPLATE="geobusquedashelp.html";M.control.Geobusquedas.SEARCHING_CLASS="searching";M.control.Geobusquedas.HIDDEN_RESULTS_CLASS="hidden"})();P.impl={};P.impl.utils={};P.impl.utils.Geobusquedas={};
(function(){M.impl.utils.getCentroidCoordinate=function(a){var b;a.getType()===M.geom.wkt.type.POINT?b=a.getCoordinates():a.getType()===M.geom.wkt.type.LINE_STRING?(a=a.getCoordinates(),b=Math.floor(a.length/2),b=a[b]):a.getType()===M.geom.wkt.type.LINEAR_RING?(a=a.getCoordinates(),b=Math.floor(a.length/2),b=a[b]):a.getType()===M.geom.wkt.type.POLYGON?b=M.impl.utils.getCentroidCoordinate(a.getInteriorPoint()):a.getType()===M.geom.wkt.type.MULTI_POINT?(points=a.getPoints(),b=Math.floor(points.length/
2),b=M.impl.utils.getCentroidCoordinate(points[b])):a.getType()===M.geom.wkt.type.MULTI_LINE_STRING?(lineStrings=a.getLineStrings(),b=Math.floor(lineStrings.length/2),b=M.impl.utils.getCentroidCoordinate(lineStrings[b])):a.getType()===M.geom.wkt.type.MULTI_POLYGON?(points=a.getInteriorPoints(),b=M.impl.utils.getCentroidCoordinate(points)):a.getType()===M.geom.wkt.type.CIRCLE?b=a.getCenter():a.getType()===M.geom.wkt.type.GEOMETRY_COLLECTION&&(geometries=a.getGeometries(),b=Math.floor(geometries.length/
2),b=M.impl.utils.getCentroidCoordinate(geometries[b]));return b}})();var Geobusquedas={feature:{}};Geobusquedas.feature.style={};
(function(){var a={image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"rgba(255, 255, 255, 0.5)"}),stroke:new ol.style.Stroke({color:"#087021",width:1})})},b={fill:new ol.style.Fill({color:"#087021"}),stroke:new ol.style.Stroke({color:"#087021",width:2})},c={image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"rgba(252, 252, 252, 0.2)"}),stroke:new ol.style.Stroke({color:"#087021",width:1})})};Geobusquedas.feature.style.DEFAULT={};Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POINT]=
new ol.style.Style(a);Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.MULTI_POINT]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POINT];Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.LINE_STRING]=new ol.style.Style(b);Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.LINEAR_RING]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.MULTI_LINE_STRING]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POLYGON]=
new ol.style.Style(c);Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.MULTI_POLYGON]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.CIRCLE]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.GEOMETRY_COLLECTION]=Geobusquedas.feature.style.DEFAULT[M.geom.wkt.type.POLYGON];a={image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"rgba(255, 255, 255, 0.5)"}),stroke:new ol.style.Stroke({color:"#e2951b",
width:1})})};b={fill:new ol.style.Fill({color:"#e2951b"}),stroke:new ol.style.Stroke({color:"#e2951b",width:2})};c={fill:new ol.style.Fill({color:"rgba(252, 252, 252, 0)"}),stroke:new ol.style.Stroke({color:"#e2951b",width:1})};Geobusquedas.feature.style.NEW={};Geobusquedas.feature.style.NEW[M.geom.wkt.type.POINT]=new ol.style.Style(a);Geobusquedas.feature.style.NEW[M.geom.wkt.type.MULTI_POINT]=Geobusquedas.feature.style.NEW[M.geom.wkt.type.POINT];Geobusquedas.feature.style.NEW[M.geom.wkt.type.LINE_STRING]=
new ol.style.Style(b);Geobusquedas.feature.style.NEW[M.geom.wkt.type.LINEAR_RING]=Geobusquedas.feature.style.NEW[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.NEW[M.geom.wkt.type.MULTI_LINE_STRING]=Geobusquedas.feature.style.NEW[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.NEW[M.geom.wkt.type.POLYGON]=new ol.style.Style(c);Geobusquedas.feature.style.NEW[M.geom.wkt.type.MULTI_POLYGON]=Geobusquedas.feature.style.NEW[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.NEW[M.geom.wkt.type.CIRCLE]=
Geobusquedas.feature.style.NEW[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.NEW[M.geom.wkt.type.GEOMETRY_COLLECTION]=Geobusquedas.feature.style.NEW[M.geom.wkt.type.POLYGON];a={image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"#fcfcfc"}),stroke:new ol.style.Stroke({color:"#3589d1",width:2})})};b={fill:new ol.style.Fill({color:"#fcfcfc"}),stroke:new ol.style.Stroke({color:"#3589d1",width:2})};c={fill:new ol.style.Fill({color:"rgba(252, 252, 252, 0.2)"}),stroke:new ol.style.Stroke({color:"#3589d1",
width:2})};Geobusquedas.feature.style.SELECTED={};Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POINT]=new ol.style.Style(a);Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.MULTI_POINT]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POINT];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.LINE_STRING]=new ol.style.Style(b);Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.LINEAR_RING]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.MULTI_LINE_STRING]=
Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.LINE_STRING];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POLYGON]=new ol.style.Style(c);Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.MULTI_POLYGON]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.CIRCLE]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POLYGON];Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.GEOMETRY_COLLECTION]=Geobusquedas.feature.style.SELECTED[M.geom.wkt.type.POLYGON]})();P.impl.layer={};P.impl.layer.Geobusquedas={};
(function(){M.impl.layer.Geobusquedas=function(a){this.wktFormatter_=new ol.format.WKT;this.popup_=null;this.selectedFeatures_=[];this.name="geobusquedas";M.impl.Layer.call(this,a)};goog.inherits(M.impl.layer.Geobusquedas,M.impl.Layer);M.impl.layer.Geobusquedas.prototype.addTo=function(a){this.map=a;this.ol3Layer=new ol.layer.Vector({source:new ol.source.Vector({useSpatialIndex:!1}),zIndex:M.impl.Map.Z_INDEX[M.layer.type.WFS]+999});!1!==this.options.visibility&&this.setVisible(this.inRange());this.map.getMapImpl().addLayer(this.ol3Layer)};
M.impl.layer.Geobusquedas.prototype.drawResults=function(a){var b=ol.proj.get(this.map.getProjection().code),c=[];M.utils.isNullOrEmpty(a.spatial_response)||(c=a.spatial_response.docs);M.utils.isNullOrEmpty(c)&&(c=a.response.docs);a=c.map(function(a){var c=this.wktFormatter_.readFeature(a.geom,{dataProjection:b});c.setId(a.solrid);c.setProperties(a);M.impl.layer.Geobusquedas.setStyleFeature_(c,M.impl.style.STATE.DEFAULT);this.wrapComplexFeature_(c);return c},this);this.ol3Layer.getSource().addFeatures(a)};
M.impl.layer.Geobusquedas.prototype.drawNewResults=function(a){var b=ol.proj.get(this.map.getProjection().code),c;M.utils.isNullOrEmpty(a.spatial_response)?M.utils.isNullOrEmpty(a.response)||(c=a.response.docs):c=a.spatial_response.docs;a=c.map(function(a){var c=this.wktFormatter_.readFeature(a.geom,{dataProjection:b});c.setId(a.solrid);c.setProperties(a);M.impl.layer.Geobusquedas.setStyleFeature_(c,M.impl.style.STATE.NEW);return c},this);this.ol3Layer.getSource().addFeatures(a)};M.impl.layer.Geobusquedas.prototype.clear=
function(a){this.map.removePopup();this.ol3Layer.getSource().clear()};M.impl.layer.Geobusquedas.prototype.selectFeatures=function(a,b,c){this.selectedFeatures_=a;M.impl.layer.Geobusquedas.setStyleFeature_(a,M.impl.style.STATE.SELECTED);a=this.parseFeaturesForTemplate_(a);var d=this,e;M.template.compile(M.impl.layer.Geobusquedas.POPUP_RESULT,a).then(function(a){var g=d.map.getPopup();e=M.utils.htmlToString(a);M.utils.isNullOrEmpty(g)?(g=new M.Popup({title:"Geobusquedas: ",body:e},b,{panMapIfOutOfView:!c,
ani:null}),d.map.addPopup(g)):g.addContent({title:"Geobusquedas: ",body:e})})};M.impl.layer.Geobusquedas.prototype.selectFeatureBySolrid=function(a){a=this.ol3Layer.getSource().getFeatureById(a);this.selectedFeatures_=[a];var b=a.getGeometry(),c=M.impl.utils.getCentroidCoordinate(b);this.unselectFeatures();this.selectFeatures([a],c,!0);this.map.setBbox(b.getExtent())};M.impl.layer.Geobusquedas.prototype.parseFeaturesForTemplate_=function(a){var b={features:[]};a.forEach(function(a){var d=["geom",
"_version_","keywords","solrid",a.getGeometryName()],e=a.getProperties(),f=[],g;for(g in e)M.utils.includes(d,g.toLowerCase())||f.push({key:M.utils.beautifyAttributeName(g),value:e[g]});a={solrid:a.getId(),attributes:f};b.features.push(a)});return b};M.impl.layer.Geobusquedas.prototype.wrapComplexFeature_=function(a){var b=a.getGeometry();if(b.getType()===M.geom.wkt.type.POLYGON||b.getType()===M.geom.wkt.type.MULTI_POLYGON){var c;c=b.getType()===M.geom.wkt.type.POLYGON?b.getInteriorPoint():b.getInteriorPoints();
b=new ol.geom.GeometryCollection([c,b]);a.setGeometry(b)}};M.impl.layer.Geobusquedas.prototype.unselectFeatures=function(){M.impl.layer.Geobusquedas.setStyleFeature_(this.selectedFeatures_,M.impl.style.STATE.DEFAULT);this.selectedFeatures_.length=0;this.map.removePopup()};M.impl.layer.Geobusquedas.prototype.destroy=function(){var a=this.map.getMapImpl();M.utils.isNullOrEmpty(this.ol3Layer)||(a.removeLayer(this.ol3Layer),this.ol3Layer=null);this.map=null};M.impl.layer.Geobusquedas.prototype.equals=
function(a){var b=!1;a instanceof M.impl.layer.Geobusquedas&&(b=(b=this.url===a.url)&&this.name===a.name);return b};M.impl.layer.Geobusquedas.setStyleFeature_=function(a,b){M.utils.isArray(a)||(a=[a]);a.forEach(function(a){var d=a.getGeometry().getType();M.utils.isNullOrEmpty(b)||b===M.impl.style.STATE.DEFAULT?a.setStyle(Geobusquedas.feature.style.DEFAULT[d]):b===M.impl.style.STATE.NEW?a.setStyle(Geobusquedas.feature.style.NEW[d]):b===M.impl.style.STATE.SELECTED&&a.setStyle(Geobusquedas.feature.style.SELECTED[d])})};
M.impl.layer.Geobusquedas.POPUP_RESULT="geobusquedasfeaturepopup.html"})();goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);goog.dom.classes.set(a,c.join(" "));return c.length==e};
...
goog.dom.classes.has=function(a,b){return goog.array.contains(goog.dom.classes.get(a),b)};goog.dom.classes.enable=function(a,b,c){c?goog.dom.classes.add(a,b):goog.dom.classes.remove(a,b)};goog.dom.classes.toggle=function(a,b){var c=!goog.dom.classes.has(a,b);goog.dom.classes.enable(a,b,c);return c};P.impl.control={};P.impl.control.Geobusquedas={};
(function(){M.impl.control.Geobusquedas=function(){this.helpHtml_=this.facadeMap_=null;this.layer_=new M.impl.layer.Geobusquedas};goog.inherits(M.impl.control.Geobusquedas,M.impl.Control);M.impl.control.Geobusquedas.prototype.addTo=function(a,b){this.facadeMap_=a;this.layer_.addTo(a);a.getImpl().getFeaturesHandler().addLayer(this.layer_);ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.Geobusquedas.prototype.drawResults=function(a){this.layer_.drawResults(a)};
M.impl.control.Geobusquedas.prototype.drawNewResults=function(a){this.layer_.drawNewResults(a)};M.impl.control.Geobusquedas.prototype.resultClick=function(a){this.layer_.selectFeatureBySolrid(a)};M.impl.control.Geobusquedas.prototype.hideHelp=function(){M.utils.isNullOrEmpty(this.helpHtml_)||(this.facadeMap_.getMapImpl().getTargetElement().removeChild(this.helpHtml_),this.helpHtml_=null)};M.impl.control.Geobusquedas.prototype.showHelp=function(a){var b=this.facadeMap_.getMapImpl().getTargetElement();
M.utils.isNullOrEmpty(this.helpHtml_)||b.removeChild(this.helpHtml_);this.helpHtml_=a;b.appendChild(this.helpHtml_)};M.impl.control.Geobusquedas.prototype.clear=function(){this.layer_.clear()};M.impl.control.Geobusquedas.prototype.destroy=function(){this.facadeMap_.removeControl(this);this.facadeMap_=null}})();P.control.Geosearchbylocation={};
(function(){M.control.Geosearchbylocation=function(a,b,c,d,e,f,g){this.activatebtnList_=this.activate_=!0;this.searchParameters_=g;this.distance_=d;this.spatialField_=e;this.rows_=f;this.facadeMap_=null;this.searchUrl_=M.utils.concatUrlPaths([a,b,c]);M.utils.isUndefined(M.impl.control.Geosearchbylocation)&&M.exception("La implementaci\u00f3n usada no puede crear controles Geosearchbylocation");M.control.Geobusquedas.call(this,a,b,c,g);a=new M.impl.control.Geosearchbylocation(this.searchUrl_);this.setImpl(a)};
goog.inherits(M.control.Geosearchbylocation,M.control.Geobusquedas);M.control.Geosearchbylocation.prototype.equals=function(a){var b=!1;a instanceof M.control.Geosearchbylocation&&(b=this.name===a.name);return b};M.control.Geosearchbylocation.prototype.createView=function(a){var b=this;this.facadeMap_=a;return new Promise(function(a,d){M.template.compile(M.control.Geosearchbylocation.TEMPLATE).then(function(d){b.addEvents(d);a(d)})})};M.control.Geosearchbylocation.prototype.addEvents=function(a){};
M.control.Geosearchbylocation.prototype.getActivationButton=function(a){return a.querySelector("button#m-geosearchbylocation-button")};M.control.Geosearchbylocation.prototype.activate=function(){goog.dom.classlist.add(this.element_,"activated");var a=this;this.getImpl().locate().then(function(b){var c=new ol.geom.Point(b),c=(new ol.format.WKT).writeGeometry(c);a.searchFrom_(c,b)})};M.control.Geosearchbylocation.prototype.deactivate=function(){goog.dom.classlist.remove(this.element_,"activated");this.getImpl().clear();
this.getImpl().removeLocate();this.getImpl().removeResultsContainer(this.resultsContainer_)};M.control.Geosearchbylocation.prototype.drawLocation_=function(a){this.getImpl().drawLocation(a)};M.control.Geosearchbylocation.prototype.searchFrom_=function(a,b){var c=this;this.searchTime_=Date.now();var d=null,d=M.utils.addParameters(this.searchUrl_,{wt:"json",pt:a,q:"*:*",start:0,d:this.distance_,spatialField:this.spatialField_,row:this.rows_,srs:c.facadeMap_.getProjection().code});(function(a){M.remote.get(d).then(function(d){if(a===
c.searchTime_){var g;try{g=JSON.parse(d.text)}catch(h){M.exception("La respuesta no es un JSON v\u00e1lido: "+h)}c.showResults_(g);c.drawLocation_(b);goog.dom.classlist.remove(document.getElementsByTagName("button")["m-geosearchbylocation-button-list"],"m-geosearchbylocation-button-list");goog.dom.classlist.remove(document.getElementById("m-geosearchbylocation-div"),"m-geosearchbylocation-div-load")}})})(this.searchTime_)};M.control.Geosearchbylocation.prototype.showResults_=function(a){this.getImpl().clear();
this.results=a;this.showList=!0;this.drawResults(a);a=document.getElementsByTagName("button")["m-geosearchbylocation-button-list"];goog.events.listen(a,[goog.events.EventType.CLICK,goog.events.EventType.TOUCHEND],this.showList_,!1,this)};M.control.Geosearchbylocation.prototype.showList_=function(){var a=this;if(!0===this.showList){var b=a.parseResultsForTemplate_(this.results);M.template.compile(M.control.Geosearchbylocation.RESULTS_TEMPLATE,b).then(function(b){a.resultsContainer_=b;a.getImpl().addResultsContainer(a.resultsContainer_);
b=a.resultsContainer_.getElementsByClassName("result");for(var d=0,e=b.length;d<e;d++){var f=b.item(d);goog.events.listen(f,[goog.events.EventType.CLICK,goog.events.EventType.TOUCHEND],function(a){this.resultClick_(a);this.getImpl().removeResultsContainer(this.resultsContainer_);this.showList=!0},!1,a)}});this.showList=!1}else a.getImpl().removeResultsContainer(a.resultsContainer_),this.showList=!0};M.control.Geosearchbylocation.TEMPLATE="geosearchbylocation.html";M.control.Geosearchbylocation.RESULTS_TEMPLATE=
"geosearchbylocationresults.html"})();P.plugin={};P.plugin.Geosearchbylocation={};
(function(){M.plugin.Geosearchbylocation=function(a){a=a||{};this.name=M.plugin.Geosearchbylocation.NAME;this.url_=M.config.GEOSEARCH_URL;M.utils.isNullOrEmpty(a.url)||(this.url_=a.url);this.core_=M.config.GEOSEARCH_CORE;M.utils.isNullOrEmpty(a.core)||(this.core_=a.core);this.handler_=M.config.GEOSEARCH_HANDLER;M.utils.isNullOrEmpty(a.handler)||(this.handler_=a.handler);this.distance_=M.config.GEOSEARCH_DISTANCE;M.utils.isNullOrEmpty(a.distance)||(this.distance_=a.distance);this.spatialField_=M.config.GEOSEARCH_SPATIAL_FIELD;
M.utils.isNullOrEmpty(a.spatialField)||(this.spatialField_=a.spatialField);this.rows_=M.config.GEOSEARCH_ROWS;M.utils.isNullOrEmpty(a.rows)||(this.rows_=a.rows);this.searchParameters_=a.params;this.panel_=this.controlGeo=this.map_=null;M.Plugin.call(this)};goog.inherits(M.plugin.Geosearchbylocation,M.Plugin);M.plugin.Geosearchbylocation.prototype.addTo=function(a){this.map_=a;this.controlGeo=new M.control.Geosearchbylocation(this.url_,this.core_,this.handler_,this.distance_,this.spatialField_,this.rows_,
this.searchParameters_);this.panel_=new M.ui.Panel(M.plugin.Geosearchbylocation.NAME,{collapsible:!1,className:"m-geosearchbylocation",position:M.ui.position.BR});var b=a.getPanels([M.control.Location.NAME])[0],c;M.utils.isNullOrEmpty(M.plugin.Streetview)||(c=a.getPanels([M.plugin.Streetview.NAME])[0]);M.utils.isNullOrEmpty(b)||M.utils.isNullOrEmpty(c)?M.utils.isNullOrEmpty(b)?M.utils.isNullOrEmpty(c)||(c.addClassName("m-with-geosearchbylocation"),this.panel_.addClassName("m-with-streetview")):(b.addClassName("m-with-geosearchbylocation"),
this.panel_.addClassName("m-with-location")):(b.addClassName("m-with-geosearchbylocation"),c.addClassName("m-with-geosearchbylocation"),this.panel_.addClassName("m-with-location m-with-streetview"));this.panel_.addControls(this.controlGeo);this.map_.addPanels(this.panel_)};M.plugin.Geosearchbylocation.prototype.destroy=function(){this.map_.removeControls([this.controlGeo]);this.controlGeo=this.searchParameters_=this.spatialField_=this.distance_=this.handler_=this.core_=this.url_=this.name=this.map_=
null};M.plugin.Geosearchbylocation.NAME="geosearchbylocation"})();P.impl.control.Geosearchbylocation={};
(function(){M.impl.control.Geosearchbylocation=function(a){this.popup_=null;M.impl.control.Geobusquedas.call(this);this.searchUrl_=a};goog.inherits(M.impl.control.Geosearchbylocation,M.impl.control.Geobusquedas);M.impl.control.Geosearchbylocation.prototype.addTo=function(a,b){M.impl.control.Geosearchbylocation.superClass_.addTo.call(this,a,b)};M.impl.control.Geosearchbylocation.prototype.setMap=function(a){M.utils.isNullOrEmpty(a)?this.facadeMap_.getImpl().removeFeatures([this.accuracyFeature_,this.positionFeature_]):
this.map=a;M.impl.control.Geosearchbylocation.superClass_.setMap.call(this,a)};M.impl.control.Geobusquedas.prototype.locate=function(){var a=this;return new Promise(function(b,c){goog.dom.classlist.add(document.getElementById("m-geosearchbylocation-div"),"m-geosearchbylocation-div-load");var d=a.facadeMap_.getMapImpl().getView(),e=new ol.Geolocation({projection:d.getProjection()});e.setTracking(!0);a.accuracyFeature_=new ol.Feature;e.on("change:accuracyGeometry",function(){this.accuracyFeature_.setGeometry(e.getAccuracyGeometry())},
a);a.positionFeature_=new ol.Feature;a.positionFeature_.setStyle(new ol.style.Style({image:new ol.style.Circle({radius:6,fill:new ol.style.Fill({color:"#3399CC"}),stroke:new ol.style.Stroke({color:"#fff",width:2})})}));e.on("change:position",function(){a.coordinates=e.getPosition();b(a.coordinates)},a);a.positionFeature_.click=function(b){M.template.compile(M.impl.control.Geosearchbylocation.POPUP_LOCATION,{valorX:a.coordinates[0],valorY:a.coordinates[1]}).then(function(b){a.popup_=new M.Popup(b,
a.coordinates);a.facadeMap_.addPopup(a.popup_)})}})};M.impl.control.Geobusquedas.prototype.removeLocate=function(){this.facadeMap_.getImpl().removeFeatures([this.accuracyFeature_,this.positionFeature_])};M.impl.control.Geosearchbylocation.prototype.drawLocation=function(a){this.positionFeature_.setGeometry(a?new ol.geom.Point(a):null);this.facadeMap_.getImpl().drawFeatures([this.accuracyFeature_,this.positionFeature_])};M.impl.control.Geosearchbylocation.prototype.addResultsContainer=function(a){var b=
this.map.getTargetElement();goog.dom.appendChild(b,a)};M.impl.control.Geosearchbylocation.prototype.removeResultsContainer=function(a){goog.dom.removeNode(a)};M.impl.control.Geosearchbylocation.prototype.destroy=function(){this.map.removeControl(this);this.searchUrl_=this.popup_=null;this.clear();this.map=null;this.facadeMap_.getImpl().removeFeatures([this.accuracyFeature_,this.positionFeature_]);this.facadeMap_=null};M.impl.control.Geosearchbylocation.POPUP_LOCATION="geosearchbylocationfeaturepopup.html"})();goog.exportSymbol("M.plugin.Geosearchbylocation",M.plugin.Geosearchbylocation);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"addTo",M.plugin.Geosearchbylocation.prototype.addTo);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"destroy",M.plugin.Geosearchbylocation.prototype.destroy);goog.exportSymbol("M.plugin.Geosearchbylocation.NAME",M.plugin.Geosearchbylocation.NAME);goog.exportSymbol("M.control.Geosearchbylocation",M.control.Geosearchbylocation);
goog.exportProperty(M.control.Geosearchbylocation.prototype,"equals",M.control.Geosearchbylocation.prototype.equals);goog.exportProperty(M.control.Geosearchbylocation.prototype,"createView",M.control.Geosearchbylocation.prototype.createView);goog.exportProperty(M.control.Geosearchbylocation.prototype,"addEvents",M.control.Geosearchbylocation.prototype.addEvents);goog.exportProperty(M.control.Geosearchbylocation.prototype,"getActivationButton",M.control.Geosearchbylocation.prototype.getActivationButton);
goog.exportProperty(M.control.Geosearchbylocation.prototype,"activate",M.control.Geosearchbylocation.prototype.activate);goog.exportProperty(M.control.Geosearchbylocation.prototype,"deactivate",M.control.Geosearchbylocation.prototype.deactivate);goog.exportSymbol("M.control.Geosearchbylocation.TEMPLATE",M.control.Geosearchbylocation.TEMPLATE);goog.exportSymbol("M.control.Geosearchbylocation.RESULTS_TEMPLATE",M.control.Geosearchbylocation.RESULTS_TEMPLATE);
goog.exportSymbol("M.impl.control.Geosearchbylocation",M.impl.control.Geosearchbylocation);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"addTo",M.impl.control.Geosearchbylocation.prototype.addTo);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"setMap",M.impl.control.Geosearchbylocation.prototype.setMap);goog.exportProperty(M.impl.control.Geobusquedas.prototype,"locate",M.impl.control.Geobusquedas.prototype.locate);
goog.exportProperty(M.impl.control.Geobusquedas.prototype,"removeLocate",M.impl.control.Geobusquedas.prototype.removeLocate);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"drawLocation",M.impl.control.Geosearchbylocation.prototype.drawLocation);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"addResultsContainer",M.impl.control.Geosearchbylocation.prototype.addResultsContainer);
goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"removeResultsContainer",M.impl.control.Geosearchbylocation.prototype.removeResultsContainer);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"destroy",M.impl.control.Geosearchbylocation.prototype.destroy);goog.exportSymbol("M.impl.control.Geosearchbylocation.POPUP_LOCATION",M.impl.control.Geosearchbylocation.POPUP_LOCATION);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"locate",M.impl.control.Geosearchbylocation.prototype.locate);
goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"removeLocate",M.impl.control.Geosearchbylocation.prototype.removeLocate); })(window.M);
