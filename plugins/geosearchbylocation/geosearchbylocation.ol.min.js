...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};var P={control:{}};P.control.Geosearch={};
...
M.utils.isNullOrEmpty(this.helpHtml_)||b.removeChild(this.helpHtml_);this.helpHtml_=a;b.appendChild(this.helpHtml_)};M.impl.control.Geosearch.prototype.clear=function(){this.layer_.clear()};M.impl.control.Geosearch.prototype.destroy=function(){this.clear();goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.facadeMap_.getMapImpl().removeControl(this);this.layer_=this.helpHtml_=this.facadeMap_=null}})();P.control.Geosearchbylocation={};
(function(){M.control.Geosearchbylocation=function(a,b,c,d,e,f){this.activatebtnList_=this.activate_=!0;this.distance_=d;this.spatialField_=e;this.rows_=f;this.searchUrl_=M.utils.concatUrlPaths([a,b,c]);this.resultsScrollContainer_=this.facadeMap_=null;M.utils.isUndefined(M.impl.control.Geosearchbylocation)&&M.exception("La implementaci\u00f3n usada no puede crear controles Geosearchbylocation");M.control.Geosearch.call(this,a,b,c);this.name=M.control.Geosearchbylocation.NAME;a=new M.impl.control.Geosearchbylocation(this.searchUrl_);
this.setImpl(a)};goog.inherits(M.control.Geosearchbylocation,M.control.Geosearch);M.control.Geosearchbylocation.prototype.equals=function(a){var b=!1;a instanceof M.control.Geosearchbylocation&&(b=this.name===a.name);return b};M.control.Geosearchbylocation.prototype.createView=function(a){this.facadeMap_=a;return M.template.compile(M.control.Geosearchbylocation.TEMPLATE,{jsonp:!0})};M.control.Geosearchbylocation.prototype.getActivationButton=function(a){return a.querySelector("button#m-geosearchbylocation-button")};
M.control.Geosearchbylocation.prototype.activate=function(){goog.dom.classlist.add(this.element_,"activated");goog.dom.classlist.add(this.element_,M.control.Geosearch.SEARCHING_CLASS);var a=this;this.getImpl().locate().then(function(b){var c=new ol.geom.Point(b),c=(new ol.format.WKT).writeGeometry(c);a.searchFrom_(c,b)})};M.control.Geosearchbylocation.prototype.deactivate=function(){goog.dom.classlist.remove(this.element_,"activated");this.getImpl().clear();this.getImpl().removeLocate();this.getImpl().removeResultsContainer(this.resultsContainer_)};
M.control.Geosearchbylocation.prototype.drawLocation_=function(a){this.getImpl().drawLocation(a)};M.control.Geosearchbylocation.prototype.searchFrom_=function(a,b){var c=null,c=M.utils.addParameters(this.searchUrl_,{wt:"json",pt:a,q:"*:*",start:0,d:this.distance_,spatialField:this.spatialField_,rows:this.rows_,srs:this.map_.getProjection().code});this.searchTime_=Date.now();var d=this;(function(a){M.remote.get(c).then(function(c){if(a===d.searchTime_){var e;try{e=JSON.parse(c.text)}catch(h){M.exception("La respuesta no es un JSON v\u00e1lido: "+
h)}d.showResults_(e);d.drawLocation_(b);d.zoomToResultsAll_();goog.dom.classlist.remove(d.activationBtn_,M.control.Geosearch.HIDDEN_RESULTS_CLASS);goog.dom.classlist.remove(d.element_,M.control.Geosearch.SEARCHING_CLASS)}})})(this.searchTime_)};M.control.Geosearchbylocation.prototype.zoomToResultsAll_=function(){this.getImpl().zoomToResultsAll()};M.control.Geosearchbylocation.prototype.showResults_=function(a){this.getImpl().clear();this.results=a;this.showList=!0;this.drawResults(a);a=this.element_.querySelector("button#m-geosearchbylocation-button-list");
goog.events.listen(a,goog.events.EventType.CLICK,this.showList_,!1,this)};M.control.Geosearchbylocation.prototype.showList_=function(){var a=this;if(!0===this.showList){var b=a.parseResultsForTemplate_(this.results);M.template.compile(M.control.Geosearchbylocation.RESULTS_TEMPLATE,{jsonp:!0,vars:b}).then(function(b){a.resultsContainer_=b;a.resultsScrollContainer_=a.resultsContainer_.querySelector("div#m-geosearchbylocation-results-scroll");M.utils.enableTouchScroll(a.resultsScrollContainer_);a.getImpl().addResultsContainer(a.resultsContainer_);
for(var c=a.resultsContainer_.getElementsByClassName("result"),e=0,f=c.length;e<f;e++){var g=c.item(e);goog.events.listen(g,goog.events.EventType.CLICK,function(a){this.resultClick_(a);this.getImpl().removeResultsContainer(this.resultsContainer_);this.showList=!0},!1,a)}b=b.querySelector(".title > button.m-panel-btn");goog.events.listen(b,goog.events.EventType.CLICK,a.showList_,!1,a)});this.showList=!1}else a.getImpl().removeResultsContainer(a.resultsContainer_),this.showList=!0};M.control.Geosearchbylocation.prototype.resultsClick_=
function(a){goog.dom.classlist.toggle(this.resultsContainer_,M.control.Geosearch.HIDDEN_RESULTS_CLASS)};M.control.Geosearchbylocation.NAME="geosearchbylocation";M.control.Geosearchbylocation.HIDDEN="hidden";M.control.Geosearchbylocation.TEMPLATE="geosearchbylocation.html";M.control.Geosearchbylocation.RESULTS_TEMPLATE="geosearchbylocationresults.html"})();P.plugin={};P.plugin.Geosearchbylocation={};
...
this.rows_=M.config.GEOSEARCHBYLOCATION_ROWS;this.panel_=this.controlGeo=this.map_=null;M.Plugin.call(this)};goog.inherits(M.plugin.Geosearchbylocation,M.Plugin);M.plugin.Geosearchbylocation.prototype.addTo=function(a){this.map_=a;this.controlGeo=new M.control.Geosearchbylocation(this.url_,this.core_,this.handler_,this.distance_,this.spatialField_,this.rows_);this.panel_=new M.ui.Panel(M.plugin.Geosearchbylocation.NAME,{collapsible:!1,className:"m-geosearchbylocation",position:M.ui.position.BR});
var b=a.getPanels([M.control.Location.NAME])[0],c;M.utils.isNullOrEmpty(M.plugin.Streetview)||(c=a.getPanels([M.plugin.Streetview.NAME])[0]);M.utils.isNullOrEmpty(b)||M.utils.isNullOrEmpty(c)?M.utils.isNullOrEmpty(b)?M.utils.isNullOrEmpty(c)||(c.addClassName("m-with-geosearchbylocation"),this.panel_.addClassName("m-with-streetview")):(b.addClassName("m-with-geosearchbylocation"),this.panel_.addClassName("m-with-location")):(b.addClassName("m-with-geosearchbylocation"),c.addClassName("m-with-geosearchbylocation"),
this.panel_.addClassName("m-with-location m-with-streetview"));this.panel_.addControls(this.controlGeo);this.map_.addPanels(this.panel_)};M.plugin.Geosearchbylocation.prototype.destroy=function(){this.map_.removeControls([this.controlGeo=null]);this.panel_=this.controlGeo=this.map_=this.rows_=this.spatialField_=this.distance_=this.handler_=this.core_=this.url_=this.name=null};M.plugin.Geosearchbylocation.NAME="geosearchbylocation"})();P.impl.control.Geosearchbylocation={};
(function(){M.impl.control.Geosearchbylocation=function(a){this.popup_=null;this.searchUrl_=a;M.impl.control.Geosearch.call(this,{layerName:M.control.Geosearchbylocation.NAME})};goog.inherits(M.impl.control.Geosearchbylocation,M.impl.control.Geosearch);M.impl.control.Geosearchbylocation.prototype.setMap=function(a){M.utils.isNullOrEmpty(a)?this.facadeMap_.getImpl().removeFeatures([this.positionFeature_]):this.map=a;M.impl.control.Geosearchbylocation.superClass_.setMap.call(this,a)};M.impl.control.Geosearch.prototype.locate=
function(){var a=new ol.Geolocation({projection:this.facadeMap_.getMapImpl().getView().getProjection()});a.setTracking(!0);this.positionFeature_=new ol.Feature;this.positionFeature_.setStyle(new ol.style.Style({image:new ol.style.Circle({radius:6,fill:new ol.style.Fill({color:"#3399CC"}),stroke:new ol.style.Stroke({color:"#fff",width:2})})}));var b=this,c;this.positionFeature_.click=function(a){M.template.compile(M.impl.control.Geosearchbylocation.POPUP_LOCATION,{jsonp:!0,vars:{valorX:c[0],valorY:c[1]},
parseToHtml:!1}).then(function(a){a={icon:"g-cartografia-gps2",title:"posici\u00f3n",content:a};b.popup_=b.facadeMap_.getPopup();M.utils.isNullOrEmpty(b.popup_)?(b.popup_=new M.Popup,b.popup_.addTab(a),b.facadeMap_.addPopup(b.popup_,c)):b.popup_.addTab(a)})};return new Promise(function(b,e){a.on("change:position",function(){a.setTracking(!1);c=a.getPosition();b(c)},this)})};M.impl.control.Geosearch.prototype.removeLocate=function(){this.facadeMap_.getImpl().removeFeatures([this.positionFeature_])};
M.impl.control.Geosearchbylocation.prototype.drawLocation=function(a){this.positionFeature_.setGeometry(a?new ol.geom.Point(a):null);this.facadeMap_.getImpl().drawFeatures([this.positionFeature_])};M.impl.control.Geosearchbylocation.prototype.addResultsContainer=function(a){var b=this.map.getTargetElement();goog.dom.appendChild(b,a)};M.impl.control.Geosearchbylocation.prototype.removeResultsContainer=function(a){goog.dom.removeNode(a)};M.impl.control.Geosearchbylocation.prototype.zoomToResultsAll=
function(){var a=this.facadeMap_.getControls("geosearchbylocation")[0].getImpl().getLayer().getOL3Layer().getSource().getFeatures().concat(this.facadeMap_.getImpl().getDrawLayer().getOL3Layer().getSource().getFeatures()),a=ol.extent.boundingExtent(a.map(function(a){return ol.extent.getCenter(a.getGeometry().getExtent())}));this.facadeMap_.setBbox(a)};M.impl.control.Geosearchbylocation.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.clear();this.facadeMap_.getImpl().removeFeatures([this.positionFeature_]);
this.searchUrl_=this.popup_=null};M.impl.control.Geosearchbylocation.POPUP_LOCATION="geosearchbylocationfeaturepopup.html"})();goog.exportSymbol("M.plugin.Geosearchbylocation",M.plugin.Geosearchbylocation);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"name",M.plugin.Geosearchbylocation.prototype.name);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"controlGeo",M.plugin.Geosearchbylocation.prototype.controlGeo);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"addTo",M.plugin.Geosearchbylocation.prototype.addTo);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"destroy",M.plugin.Geosearchbylocation.prototype.destroy);
goog.exportSymbol("M.plugin.Geosearchbylocation.NAME",M.plugin.Geosearchbylocation.NAME);goog.exportSymbol("M.control.Geosearchbylocation",M.control.Geosearchbylocation);goog.exportProperty(M.control.Geosearchbylocation.prototype,"equals",M.control.Geosearchbylocation.prototype.equals);goog.exportProperty(M.control.Geosearchbylocation.prototype,"createView",M.control.Geosearchbylocation.prototype.createView);goog.exportProperty(M.control.Geosearchbylocation.prototype,"getActivationButton",M.control.Geosearchbylocation.prototype.getActivationButton);
goog.exportProperty(M.control.Geosearchbylocation.prototype,"activate",M.control.Geosearchbylocation.prototype.activate);goog.exportProperty(M.control.Geosearchbylocation.prototype,"deactivate",M.control.Geosearchbylocation.prototype.deactivate);goog.exportSymbol("M.control.Geosearchbylocation.NAME",M.control.Geosearchbylocation.NAME);goog.exportSymbol("M.control.Geosearchbylocation.HIDDEN",M.control.Geosearchbylocation.HIDDEN);goog.exportSymbol("M.control.Geosearchbylocation.TEMPLATE",M.control.Geosearchbylocation.TEMPLATE);
goog.exportSymbol("M.control.Geosearchbylocation.RESULTS_TEMPLATE",M.control.Geosearchbylocation.RESULTS_TEMPLATE);goog.exportSymbol("M.impl.control.Geosearchbylocation",M.impl.control.Geosearchbylocation);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"setMap",M.impl.control.Geosearchbylocation.prototype.setMap);goog.exportProperty(M.impl.control.Geosearch.prototype,"locate",M.impl.control.Geosearch.prototype.locate);
goog.exportProperty(M.impl.control.Geosearch.prototype,"removeLocate",M.impl.control.Geosearch.prototype.removeLocate);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"drawLocation",M.impl.control.Geosearchbylocation.prototype.drawLocation);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"addResultsContainer",M.impl.control.Geosearchbylocation.prototype.addResultsContainer);
goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"removeResultsContainer",M.impl.control.Geosearchbylocation.prototype.removeResultsContainer);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"zoomToResultsAll",M.impl.control.Geosearchbylocation.prototype.zoomToResultsAll);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"destroy",M.impl.control.Geosearchbylocation.prototype.destroy);
goog.exportSymbol("M.impl.control.Geosearchbylocation.POPUP_LOCATION",M.impl.control.Geosearchbylocation.POPUP_LOCATION);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"locate",M.impl.control.Geosearchbylocation.prototype.locate);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"removeLocate",M.impl.control.Geosearchbylocation.prototype.removeLocate); })(window.M);
