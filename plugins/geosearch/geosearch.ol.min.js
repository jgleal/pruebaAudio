...
"hidden"})();P.plugin={};P.plugin.Geosearch={};
(function(){M.plugin.Geosearch=function(a){a=a||{};this.panel_=this.control_=this.map_=null;this.url_=M.config.GEOSEARCH_URL;M.utils.isNullOrEmpty(a.url)||(this.url_=a.url);this.core_=M.config.GEOSEARCH_CORE;M.utils.isNullOrEmpty(a.core)||(this.core_=a.core);this.handler_=M.config.GEOSEARCH_HANDLER;M.utils.isNullOrEmpty(a.handler)||(this.handler_=a.handler);this.searchParameters_=a.params||{};M.Plugin.call(this)};goog.inherits(M.plugin.Geosearch,M.Plugin);M.plugin.Geosearch.prototype.addTo=function(a){this.map_=
a;goog.dom.classlist.add(a._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.control_=new M.control.Geosearch(this.url_,this.core_,this.handler_,this.searchParameters_);this.control_.on(M.evt.ADD_TO_MAP,this.onLoadCallback_,this);this.panel_=new M.ui.Panel("geosearch",{collapsible:!0,className:"m-geosearch",collapsedButtonClass:"g-cartografia-zoom",position:M.ui.position.TL,tooltip:"Geob\u00fasquedas"});this.panel_.addControls(this.control_);this.map_.addPanels(this.panel_)};
M.plugin.Geosearch.prototype.getInput=function(){var a=null;M.utils.isNullOrEmpty(this.control_)||(a=this.control_.getInput());return a};M.plugin.Geosearch.prototype.destroy=function(){this.map_.removeControls([this.control_]);this.searchParameters_=this.handler_=this.core_=this.url_=this.panel_=this.control_=this.map_=null}})();P.impl={};P.impl.utils={};P.impl.utils.Geosearch={};
...
M.utils.isNullOrEmpty(this.helpHtml_)||b.removeChild(this.helpHtml_);this.helpHtml_=a;b.appendChild(this.helpHtml_)};M.impl.control.Geosearch.prototype.clear=function(){this.layer_.clear()};M.impl.control.Geosearch.prototype.destroy=function(){this.clear();goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.facadeMap_.getMapImpl().removeControl(this);this.layer_=this.helpHtml_=this.facadeMap_=null}})();goog.exportSymbol("M.plugin.Geosearch",M.plugin.Geosearch);goog.exportProperty(M.plugin.Geosearch.prototype,"addTo",M.plugin.Geosearch.prototype.addTo);goog.exportProperty(M.plugin.Geosearch.prototype,"getInput",M.plugin.Geosearch.prototype.getInput);goog.exportProperty(M.plugin.Geosearch.prototype,"destroy",M.plugin.Geosearch.prototype.destroy);goog.exportSymbol("M.control.Geosearch",M.control.Geosearch);goog.exportProperty(M.control.Geosearch.prototype,"createView",M.control.Geosearch.prototype.createView);
goog.exportProperty(M.control.Geosearch.prototype,"addEvents",M.control.Geosearch.prototype.addEvents);goog.exportProperty(M.control.Geosearch.prototype,"drawResults",M.control.Geosearch.prototype.drawResults);goog.exportProperty(M.control.Geosearch.prototype,"drawNewResults",M.control.Geosearch.prototype.drawNewResults);goog.exportProperty(M.control.Geosearch.prototype,"zoomToResults",M.control.Geosearch.prototype.zoomToResults);goog.exportProperty(M.control.Geosearch.prototype,"getInput",M.control.Geosearch.prototype.getInput);
goog.exportProperty(M.control.Geosearch.prototype,"equals",M.control.Geosearch.prototype.equals);goog.exportSymbol("M.control.Geosearch.NAME",M.control.Geosearch.NAME);goog.exportSymbol("M.control.Geosearch.TEMPLATE",M.control.Geosearch.TEMPLATE);goog.exportSymbol("M.control.Geosearch.RESULTS_TEMPLATE",M.control.Geosearch.RESULTS_TEMPLATE);goog.exportSymbol("M.control.Geosearch.HELP_TEMPLATE",M.control.Geosearch.HELP_TEMPLATE);goog.exportSymbol("M.control.Geosearch.SEARCHING_CLASS",M.control.Geosearch.SEARCHING_CLASS);
goog.exportSymbol("M.control.Geosearch.HIDDEN_RESULTS_CLASS",M.control.Geosearch.HIDDEN_RESULTS_CLASS);goog.exportSymbol("M.impl.control.Geosearch",M.impl.control.Geosearch);goog.exportProperty(M.impl.control.Geosearch.prototype,"addTo",M.impl.control.Geosearch.prototype.addTo);goog.exportProperty(M.impl.control.Geosearch.prototype,"unselectResults",M.impl.control.Geosearch.prototype.unselectResults);goog.exportProperty(M.impl.control.Geosearch.prototype,"setNewResultsAsDefault",M.impl.control.Geosearch.prototype.setNewResultsAsDefault);
goog.exportProperty(M.impl.control.Geosearch.prototype,"drawResults",M.impl.control.Geosearch.prototype.drawResults);goog.exportProperty(M.impl.control.Geosearch.prototype,"drawNewResults",M.impl.control.Geosearch.prototype.drawNewResults);goog.exportProperty(M.impl.control.Geosearch.prototype,"zoomToResults",M.impl.control.Geosearch.prototype.zoomToResults);goog.exportProperty(M.impl.control.Geosearch.prototype,"getLayer",M.impl.control.Geosearch.prototype.getLayer);
goog.exportProperty(M.impl.control.Geosearch.prototype,"resultClick",M.impl.control.Geosearch.prototype.resultClick);goog.exportProperty(M.impl.control.Geosearch.prototype,"hideHelp",M.impl.control.Geosearch.prototype.hideHelp);goog.exportProperty(M.impl.control.Geosearch.prototype,"showHelp",M.impl.control.Geosearch.prototype.showHelp);goog.exportProperty(M.impl.control.Geosearch.prototype,"clear",M.impl.control.Geosearch.prototype.clear);
goog.exportProperty(M.impl.control.Geosearch.prototype,"destroy",M.impl.control.Geosearch.prototype.destroy);goog.exportSymbol("M.impl.layer.Geosearch",M.impl.layer.Geosearch);goog.exportProperty(M.impl.layer.Geosearch.prototype,"addTo",M.impl.layer.Geosearch.prototype.addTo);goog.exportProperty(M.impl.layer.Geosearch.prototype,"drawResults",M.impl.layer.Geosearch.prototype.drawResults);goog.exportProperty(M.impl.layer.Geosearch.prototype,"drawNewResults",M.impl.layer.Geosearch.prototype.drawNewResults);
goog.exportProperty(M.impl.layer.Geosearch.prototype,"clear",M.impl.layer.Geosearch.prototype.clear);goog.exportProperty(M.impl.layer.Geosearch.prototype,"selectFeatures",M.impl.layer.Geosearch.prototype.selectFeatures);goog.exportProperty(M.impl.layer.Geosearch.prototype,"selectFeatureBySolrid",M.impl.layer.Geosearch.prototype.selectFeatureBySolrid);goog.exportProperty(M.impl.layer.Geosearch.prototype,"unselectFeatures",M.impl.layer.Geosearch.prototype.unselectFeatures);
goog.exportProperty(M.impl.layer.Geosearch.prototype,"setNewResultsAsDefault",M.impl.layer.Geosearch.prototype.setNewResultsAsDefault);goog.exportProperty(M.impl.layer.Geosearch.prototype,"destroy",M.impl.layer.Geosearch.prototype.destroy);goog.exportProperty(M.impl.layer.Geosearch.prototype,"equals",M.impl.layer.Geosearch.prototype.equals);goog.exportSymbol("M.impl.layer.Geosearch.POPUP_RESULT",M.impl.layer.Geosearch.POPUP_RESULT); })(window.M);
