...
if(c)for(g=0;!b.propagationStopped_&&g<c.length;g++)f=b.currentTarget=c[g],e=f.fireListeners(d,!1,b)&&e;return e};goog.style.bidi={};goog.style.bidi.getScrollLeft=function(a){var b=goog.style.isRightToLeft(a);return b&&goog.userAgent.GECKO?-a.scrollLeft:!b||goog.userAgent.IE&&goog.userAgent.isVersionOrHigher("8")||"visible"==goog.style.getComputedOverflowX(a)?a.scrollLeft:a.scrollWidth-a.clientWidth-a.scrollLeft};
...
goog.fx.Dragger.prototype.getEnabled=function(){return this.enabled_};goog.fx.Dragger.prototype.setEnabled=function(a){this.enabled_=a};goog.fx.Dragger.prototype.setPreventMouseDown=function(a){this.preventMouseDown_=a};
...
c);b=c.x;c=c.y;this.dragging_&&this.dispatchEvent(new goog.fx.DragEvent(goog.fx.Dragger.EventType.BEFOREDRAG,this,a.clientX,a.clientY,a,b,c))&&(this.doDrag(a,b,c,!1),a.preventDefault())}};
...
goog.inherits(goog.fx.DragEvent,goog.events.Event);var P={control:{}};P.control.Streetview={};
(function(){M.control.Streetview=function(){M.utils.isUndefined(M.impl.control.Streetview)&&M.exception("La implementaci\u00f3n usada no puede crear controles Streetview");var a=new M.impl.control.Streetview;this.canvas_=null;M.Control.call(this,a)};goog.inherits(M.control.Streetview,M.Control);M.control.Streetview.prototype.createView=function(a){this.facadeMap_=a;var b=this;return M.template.compile(M.control.Streetview.TEMPLATE_DIALOG).then(function(c){b.canvas_=c.querySelector("div#streetview-canvas");
goog.dom.appendChild(a.getContainer(),c);c=c.querySelector("div#closeStreetView");goog.events.listen(c,goog.events.EventType.CLICK,b.closeStreetView,!1,b);return M.template.compile(M.control.Streetview.TEMPLATE)})};M.control.Streetview.prototype.manageActivation=function(a){this.element_=a;var b=a.querySelector("button#streetViewControl");a=new goog.fx.Dragger(b);a.setHysteresis(0);goog.events.listen(a,"start",function(a){goog.dom.classlist.remove(b,"g-cartografia-posicion2");goog.dom.classlist.add(b,
"g-cartografia-posicion5");goog.dom.classlist.add(b,"m-dragging")});goog.events.listen(a,"end",function(a){goog.dom.classlist.remove(b,"m-dragging");goog.dom.classlist.remove(b,"g-cartografia-posicion5");goog.dom.classlist.add(b,"g-cartografia-posicion2");goog.style.setStyle(b,"top",0);goog.style.setStyle(b,"left",0);this.openStreetView(a)},!1,this)};M.control.Streetview.prototype.closeStreetView=function(a){goog.style.setStyle(this.canvas_,"visibility","hidden");myPano.setVisible(!1)};M.control.Streetview.prototype.equals=
function(a){return a instanceof M.control.Streetview};M.control.Streetview.prototype.openStreetView=function(a){this.getImpl().openStreetView(a,this.canvas_)};M.control.Streetview.NAME="streetview";M.control.Streetview.TEMPLATE="streetview.html";M.control.Streetview.TEMPLATE_DIALOG="streetview_dialog.html"})();P.plugin={};P.plugin.Streetview={};M.plugin.Streetview=function(){this.panel_=this.map_=null;M.Plugin.call(this)};goog.inherits(M.plugin.Streetview,M.Plugin);
M.plugin.Streetview.prototype.addTo=function(a){this.map_=a;this.streetview=new M.control.Streetview;this.panel_=new M.ui.Panel(M.plugin.Streetview.NAME,{collapsible:!1,className:"m-streetview",position:M.ui.position.BR});var b=a.getPanels([M.control.Location.NAME])[0],c;M.utils.isNullOrEmpty(M.plugin.Geosearchbylocation)||(c=a.getPanels([M.plugin.Geosearchbylocation.NAME])[0]);M.utils.isNullOrEmpty(b)||M.utils.isNullOrEmpty(c)?M.utils.isNullOrEmpty(b)?M.utils.isNullOrEmpty(c)||(c.addClassName("m-with-streetview"),
this.panel_.addClassName("m-with-geosearchbylocation")):(b.addClassName("m-with-streetview"),this.panel_.addClassName("m-with-location")):(b.addClassName("m-with-streetview"),c.addClassName("m-with-streetview"),this.panel_.addClassName("m-with-location m-with-geosearchbylocation"));this.panel_.addControls(this.streetview);this.map_.addPanels(this.panel_)};M.plugin.Streetview.prototype.destroy=function(){this.map_.removeControls([this.streetview]);this.map_=null};M.plugin.Streetview.NAME="streetview";P.impl={};P.impl.control={};P.impl.control.Streetview={};
(function(){M.impl.control.Streetview=function(){this.sv=null};goog.inherits(M.impl.control.Streetview,M.impl.Control);M.impl.control.Streetview.prototype.openStreetView=function(a,b){this.initializeStreetView(b);if(a.clientX&&a.clientY){var c=this.facadeMap_.getMapImpl().getCoordinateFromPixel([a.clientX,a.clientY]),c=new ol.geom.Point(c),c=ol.proj.transform(c.getCoordinates(),this.facadeMap_.getImpl().getProjection().code,ol.proj.get("EPSG:4326")),c=new google.maps.LatLng(c[1],c[0]);this.sv.getPanoramaByLocation(c,
50,function(a,c){this.processSVData(a,c,b)}.bind(this))}};M.impl.control.Streetview.prototype.processSVData=function(a,b,c){b==google.maps.StreetViewStatus.OK?(myPano.setPosition(a.location.latLng),c.style.visibility="visible",c.style.position="absolute",c.style.marginLeft="10vw",c.style.width="80vw",c.style.height="80vh",c.style.top="10vh",c.style.overflow="",myPano.setVisible(!0)):M.dialog.info("No hay ninguna vista disponible en la zona seleccionada")};M.impl.control.Streetview.prototype.initializeStreetView=
function(a){myPano=new google.maps.StreetViewPanorama(a,{position:new google.maps.LatLng(0,0),pov:{heading:165,pitch:0},zoom:1});this.sv=new google.maps.StreetViewService};M.impl.control.Streetview.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this)}})();goog.exportSymbol("M.plugin.Streetview",M.plugin.Streetview);goog.exportProperty(M.plugin.Streetview.prototype,"addTo",M.plugin.Streetview.prototype.addTo);goog.exportProperty(M.plugin.Streetview.prototype,"destroy",M.plugin.Streetview.prototype.destroy);goog.exportSymbol("M.plugin.Streetview.NAME",M.plugin.Streetview.NAME);goog.exportSymbol("M.control.Streetview",M.control.Streetview);goog.exportProperty(M.control.Streetview.prototype,"createView",M.control.Streetview.prototype.createView);
goog.exportProperty(M.control.Streetview.prototype,"manageActivation",M.control.Streetview.prototype.manageActivation);goog.exportProperty(M.control.Streetview.prototype,"closeStreetView",M.control.Streetview.prototype.closeStreetView);goog.exportProperty(M.control.Streetview.prototype,"equals",M.control.Streetview.prototype.equals);goog.exportProperty(M.control.Streetview.prototype,"openStreetView",M.control.Streetview.prototype.openStreetView);goog.exportSymbol("M.control.Streetview.NAME",M.control.Streetview.NAME);
goog.exportSymbol("M.control.Streetview.TEMPLATE",M.control.Streetview.TEMPLATE);goog.exportSymbol("M.control.Streetview.TEMPLATE_DIALOG",M.control.Streetview.TEMPLATE_DIALOG);goog.exportSymbol("M.impl.control.Streetview",M.impl.control.Streetview);goog.exportProperty(M.impl.control.Streetview.prototype,"openStreetView",M.impl.control.Streetview.prototype.openStreetView);goog.exportProperty(M.impl.control.Streetview.prototype,"processSVData",M.impl.control.Streetview.prototype.processSVData);
goog.exportProperty(M.impl.control.Streetview.prototype,"destroy",M.impl.control.Streetview.prototype.destroy); })(window.M);
