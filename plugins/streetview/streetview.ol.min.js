...
if(c)for(g=0;!b.propagationStopped_&&g<c.length;g++)f=b.currentTarget=c[g],e=f.fireListeners(d,!1,b)&&e;return e};goog.style.bidi={};goog.style.bidi.getScrollLeft=function(a){var b=goog.style.isRightToLeft(a);return b&&goog.userAgent.GECKO?-a.scrollLeft:!b||goog.userAgent.EDGE_OR_IE&&goog.userAgent.isVersionOrHigher("8")||"visible"==goog.style.getComputedOverflowX(a)?a.scrollLeft:a.scrollWidth-a.clientWidth-a.scrollLeft};
...
!1;goog.events.listen(this.handle,[goog.events.EventType.TOUCHSTART,goog.events.EventType.MOUSEDOWN],this.startDrag,!1,this)};goog.inherits(goog.fx.Dragger,goog.events.EventTarget);goog.tagUnsealableClass(goog.fx.Dragger);goog.fx.Dragger.HAS_SET_CAPTURE_=goog.global.document&&goog.global.document.documentElement&&!!goog.global.document.documentElement.setCapture&&!!goog.global.document.releaseCapture;
...
goog.fx.Dragger.EventType={EARLY_CANCEL:"earlycancel",START:"start",BEFOREDRAG:"beforedrag",DRAG:"drag",END:"end"};goog.fx.Dragger.prototype.enableRightPositioningForRtl=function(a){this.useRightPositioningForRtl_=a};goog.fx.Dragger.prototype.getHandler=function(){return this.eventHandler_};goog.fx.Dragger.prototype.setLimits=function(a){this.limits=a||new goog.math.Rect(NaN,NaN,NaN,NaN)};goog.fx.Dragger.prototype.setHysteresis=function(a){this.hysteresisDistanceSquared_=Math.pow(a,2)};
goog.fx.Dragger.prototype.getHysteresis=function(){return Math.sqrt(this.hysteresisDistanceSquared_)};goog.fx.Dragger.prototype.setScrollTarget=function(a){this.scrollTarget_=a};goog.fx.Dragger.prototype.setCancelIeDragStart=function(a){this.ieDragStartCancellingOn_=a};goog.fx.Dragger.prototype.getEnabled=function(){return this.enabled_};goog.fx.Dragger.prototype.setEnabled=function(a){this.enabled_=a};goog.fx.Dragger.prototype.setPreventMouseDown=function(a){this.preventMouseDown_=a};
...
goog.fx.DragEvent=function(a,b,c,d,e,f,g,h){goog.events.Event.call(this,a);this.clientX=c;this.clientY=d;this.browserEvent=e;this.left=goog.isDef(f)?f:b.deltaX;this.top=goog.isDef(g)?g:b.deltaY;this.dragger=b;this.dragCanceled=!!h};goog.inherits(goog.fx.DragEvent,goog.events.Event);var P={control:{}};P.control.Streetview={};
(function(){M.control.Streetview=function(){M.utils.isUndefined(M.impl.control.Streetview)&&M.exception("La implementaci\u00f3n usada no puede crear controles Streetview");var a=new M.impl.control.Streetview;this.canvas_=null;M.Control.call(this,a)};goog.inherits(M.control.Streetview,M.Control);M.control.Streetview.prototype.createView=function(a){this.facadeMap_=a;var b=this;return M.template.compile(M.control.Streetview.TEMPLATE_DIALOG,{jsonp:!0}).then(function(c){b.canvas_=c.querySelector("div#streetview-canvas");
goog.dom.appendChild(a.getContainer(),c);c=c.querySelector("div#closeStreetView");goog.events.listen(c,goog.events.EventType.CLICK,b.closeStreetView,!1,b);return M.template.compile(M.control.Streetview.TEMPLATE,{jsonp:!0})})};M.control.Streetview.prototype.manageActivation=function(a){this.element_=a;var b=a.querySelector("button#streetViewControl");a=new goog.fx.Dragger(b);a.setHysteresis(0);goog.events.listen(a,"start",function(a){goog.dom.classlist.remove(b,"g-cartografia-posicion2");goog.dom.classlist.add(b,
...
this.panel_.addClassName("m-with-geosearchbylocation")):(b.addClassName("m-with-streetview"),this.panel_.addClassName("m-with-location")):(b.addClassName("m-with-streetview"),c.addClassName("m-with-streetview"),this.panel_.addClassName("m-with-location m-with-geosearchbylocation"));this.panel_.addControls(this.streetview);this.map_.addPanels(this.panel_)};M.plugin.Streetview.prototype.destroy=function(){this.map_.removeControls([this.streetview]);this.panel_=this.streetview=this.map_=null};
M.plugin.Streetview.NAME="streetview";P.impl={};P.impl.control={};P.impl.control.Streetview={};
(function(){M.impl.control.Streetview=function(){this.sv=null};goog.inherits(M.impl.control.Streetview,M.impl.Control);M.impl.control.Streetview.prototype.openStreetView=function(a,b){this.initializeStreetView(b);a.clientX&&a.clientY&&(a=this.facadeMap_.getMapImpl().getCoordinateFromPixel([a.clientX,a.clientY]),a=new ol.geom.Point(a),a=ol.proj.transform(a.getCoordinates(),this.facadeMap_.getImpl().getProjection().code,ol.proj.get("EPSG:4326")),a=new google.maps.LatLng(a[1],a[0]),this.sv.getPanoramaByLocation(a,
50,function(a,d){this.processSVData(a,d,b)}.bind(this)))};M.impl.control.Streetview.prototype.processSVData=function(a,b,c){b==google.maps.StreetViewStatus.OK?(myPano.setPosition(a.location.latLng),c.style.visibility="visible",c.style.position="absolute",c.style.marginLeft="10vw",c.style.width="80vw",c.style.height="80vh",c.style.top="10vh",c.style.overflow="",myPano.setVisible(!0)):M.dialog.info("No hay ninguna vista disponible en la zona seleccionada")};M.impl.control.Streetview.prototype.initializeStreetView=
function(a){myPano=new google.maps.StreetViewPanorama(a,{position:new google.maps.LatLng(0,0),pov:{heading:165,pitch:0},zoom:1});this.sv=new google.maps.StreetViewService};M.impl.control.Streetview.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.sv=null}})();goog.exportSymbol("M.plugin.Streetview",M.plugin.Streetview);goog.exportProperty(M.plugin.Streetview.prototype,"streetview",M.plugin.Streetview.prototype.streetview);goog.exportProperty(M.plugin.Streetview.prototype,"addTo",M.plugin.Streetview.prototype.addTo);goog.exportProperty(M.plugin.Streetview.prototype,"destroy",M.plugin.Streetview.prototype.destroy);goog.exportSymbol("M.plugin.Streetview.NAME",M.plugin.Streetview.NAME);goog.exportSymbol("M.control.Streetview",M.control.Streetview);
goog.exportProperty(M.control.Streetview.prototype,"createView",M.control.Streetview.prototype.createView);goog.exportProperty(M.control.Streetview.prototype,"manageActivation",M.control.Streetview.prototype.manageActivation);goog.exportProperty(M.control.Streetview.prototype,"closeStreetView",M.control.Streetview.prototype.closeStreetView);goog.exportProperty(M.control.Streetview.prototype,"equals",M.control.Streetview.prototype.equals);
goog.exportProperty(M.control.Streetview.prototype,"openStreetView",M.control.Streetview.prototype.openStreetView);goog.exportSymbol("M.control.Streetview.NAME",M.control.Streetview.NAME);goog.exportSymbol("M.control.Streetview.TEMPLATE",M.control.Streetview.TEMPLATE);goog.exportSymbol("M.control.Streetview.TEMPLATE_DIALOG",M.control.Streetview.TEMPLATE_DIALOG);goog.exportSymbol("M.impl.control.Streetview",M.impl.control.Streetview);
goog.exportProperty(M.impl.control.Streetview.prototype,"openStreetView",M.impl.control.Streetview.prototype.openStreetView);goog.exportProperty(M.impl.control.Streetview.prototype,"processSVData",M.impl.control.Streetview.prototype.processSVData);goog.exportProperty(M.impl.control.Streetview.prototype,"initializeStreetView",M.impl.control.Streetview.prototype.initializeStreetView);goog.exportProperty(M.impl.control.Streetview.prototype,"destroy",M.impl.control.Streetview.prototype.destroy); })(window.M);
