...
goog.string.compareVersions=function(a,b){for(var c=0,d=goog.string.trim(String(a)).split("."),e=goog.string.trim(String(b)).split("."),f=Math.max(d.length,e.length),g=0;0==c&&g<f;g++){var h=d[g]||"",k=e[g]||"",m=RegExp("(\\d*)(\\D*)","g"),p=RegExp("(\\d*)(\\D*)","g");do{var n=m.exec(h)||["","",""],l=p.exec(k)||["","",""];if(0==n[0].length&&0==l[0].length)break;var c=0==n[1].length?0:parseInt(n[1],10),q=0==l[1].length?0:parseInt(l[1],10),c=goog.string.compareElements_(c,q)||goog.string.compareElements_(0==
n[2].length,0==l[2].length)||goog.string.compareElements_(n[2],l[2])}while(0==c)}return c};goog.string.compareElements_=function(a,b){return a<b?-1:a>b?1:0};goog.string.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c)>>>0;return b};goog.string.uniqueStringCounter_=2147483648*Math.random()|0;goog.string.createUniqueString=function(){return"goog_"+goog.string.uniqueStringCounter_++};
...
goog.array.binarySearch_=function(a,b,c,d,e){for(var f=0,g=a.length,h;f<g;){var k=f+g>>1,m;m=c?b.call(e,a[k],k,a):b(d,a[k]);0<m?f=k+1:(g=k,h=!m)}return h?f:~f};goog.array.sort=function(a,b){a.sort(b||goog.array.defaultCompare)};goog.array.stableSort=function(a,b){for(var c=0;c<a.length;c++)a[c]={index:c,value:a[c]};var d=b||goog.array.defaultCompare;goog.array.sort(a,function(a,b){return d(a.value,b.value)||a.index-b.index});for(c=0;c<a.length;c++)a[c]=a[c].value};
...
(function(){M.plugin.Autocomplete=function(a){a=a||{};this.locality_=this.map_=null;M.utils.isNullOrEmpty(a.locality)||(this.locality_=a.locality);this.url_=M.config.AUTOCOMPLETADOR_URL;M.utils.isNullOrEmpty(a.locality)?M.utils.isNullOrEmpty(a.url)||(this.url_=a.url):this.url_=M.config.SEARCHSTREET_URLCODINEAUTOCOMPLETE;this.minLength_=3;M.utils.isNullOrEmpty(a.minLength)||(this.minLength_=a.minLength);this.target_=a.target;this.html_=a.html;this.delayTime_=750;M.utils.isNullOrEmpty(a.delay)||(this.delayTime_=
a.delay);this.timeoutKey_=null;this.limit_=10;M.utils.isNullOrEmpty(a.delay)||(this.limit_=a.limit);this.resultsContainer_=null;this.busqMunicipioClick_=this.busqMunicipio_=!1;M.Plugin.call(this)};goog.inherits(M.plugin.Autocomplete,M.Plugin);M.plugin.Autocomplete.prototype.addTo=function(a){this.map_=a;goog.dom.classlist.add(this.target_,M.plugin.Autocomplete.CLASS);goog.events.listen(this.target_,goog.events.EventType.INPUT,this.keyPress_,!1,this)};M.plugin.Autocomplete.prototype.keyPress_=function(a){a.preventDefault();
M.utils.isNullOrEmpty(this.timeoutKey_)||(this.cancelSearch_(),this.timeoutKey_=null);var b=this.target_.value.trim();b.length>=this.minLength_&&(this.timeoutKey_=setTimeout(goog.bind(function(){-1!=b.indexOf(",")?this.busqMunicipio_=!0:this.busqMunicipioClick_=this.busqMunicipio_=!1;this.search_(b)},this),this.delayTime_))};M.plugin.Autocomplete.prototype.search_=function(a,b){goog.dom.classlist.remove(this.target_,M.plugin.Autocomplete.SEARCHING_CLASS);var c=this;this.evt=b;var d;d=M.utils.isNullOrEmpty(this.locality_)?
M.utils.addParameters(this.url_,{input:a.trim(),limit:this.limit_}):M.utils.addParameters(this.url_,{input:a.trim(),limit:this.limit_,codine:this.locality_});d=this.formatContent_(d," ","%20");this.searchTime_=Date.now();(function(b){M.remote.get(d).then(function(b){b=JSON.parse(b.text);b=c.parseResultsForTemplate_(b);var d=c.map_.getControls();if(M.utils.isUndefined(b.docs)){b=0;for(var e=d.length;b<e;b++)"searchstreet"===d[b].name_?d[b].completed=!1:"searchstreetgeobusquedas"===d[b].name_&&(d[b].ctrlSearchstreet.completed=
!1)}else if(M.utils.isUndefined(b.docs[0]))for(b=0,e=d.length;b<e;b++)"searchstreet"===d[b].name_?d[b].completed=!1:"searchstreetgeobusquedas"===d[b].name_&&(d[b].ctrlSearchstreet.completed=!1);else M.template.compile(M.plugin.Autocomplete.RESULTAUTOCOMPLETE,b).then(function(b){c.html_.getElementsByTagName("div")["m-autocomplete-results"].innerHTML=b.innerHTML;c.addEvents_(c.html_.getElementsByClassName("autocomplete"));if(!0===c.busqMunicipio_)if(!0===c.busqMunicipioClick_){if(c.target_.value=a.slice(0,
-1),c.html_.getElementsByTagName("div")["m-autocomplete-results"].innerHTML="",!M.utils.isUndefined(c.evt)){b=0;for(var e=d.length;b<e;b++)"searchstreetgeobusquedas"===d[b].name_?(d[b].ctrlSearchstreet.searchClick_(c.evt),d[b].ctrlSearchstreet.completed=!1,d[b].ctrlGeobusquedas.searchClick_(c.evt)):"searchstreet"===d[b].name_&&(d[b].searchClick_(c.evt),d[b].completed=!1);c.busqMunicipioClick_=!1}}else{b=c.html_.getElementsByClassName("autocomplete");for(var e=0,f=d.length;e<f;e++)if("searchstreetgeobusquedas"===
d[e].name_)if(!0===d[e].ctrlSearchstreet.completed)d[e].ctrlSearchstreet.completed=!1,c.html_.getElementsByTagName("div")["m-autocomplete-results"].innerHTML="";else for(var h=0,l=b.length;h<l;h++)c.evtClickMunicipaly_(b[h]);else if("searchstreet"===d[e].name_)if(!0===d[e].completed)d[e].completed=!1,c.html_.getElementsByTagName("div")["m-autocomplete-results"].innerHTML="";else for(h=0,l=b.length;h<l;h++)c.evtClickMunicipaly_(b[h])}else for(b=0,e=d.length;b<e;b++)"searchstreet"===d[b].name_?!0===
d[b].completed&&(c.html_.getElementsByTagName("div")["m-autocomplete-results"].innerHTML="",d[b].completed=!1):"searchstreetgeobusquedas"===d[b].name_&&!0===d[b].ctrlSearchstreet.completed&&(c.html_.getElementsByTagName("div")["m-autocomplete-results"].innerHTML="",d[b].ctrlSearchstreet.completed=!1)})})})(this.searchTime_)};M.plugin.Autocomplete.prototype.evtClickMunicipaly_=function(a){var b=this;goog.events.listen(a,goog.events.EventType.CLICK,function(a){b.clickMunicipaly_()},!1,this)};M.plugin.Autocomplete.prototype.parseResultsForTemplate_=
function(a){a=M.utils.isNullOrEmpty(this.locality_)?a.autocompletarDireccionResponse.autocompletarDireccionReturn.autocompletarDireccionReturn:a.autocompletarDireccionMunicipioResponse.autocompletarDireccionMunicipioReturn.autocompletarDireccionMunicipioReturn;var b=[];if(!0===this.busqMunicipio_)if(M.utils.isUndefined(a))this.html_.getElementsByTagName("div")["m-autocomplete-results"].innerHTML="";else{!1===a instanceof Array&&(a=[a]);for(var c=0,d=a.length;c<d;c++){var e=a[c].split(",");b.push(e[0]+
" "+e[1]+", "+e[3]+" ("+e[e.length-1]+")")}a=b}else if(!1===a instanceof Array){if(b.push(a),a=b,!M.utils.isUndefined(a[0]))for(b=0,c=a.length;b<c;b++)a[b]=this.formatContent_(a[b],","," ")}else for(b=0,c=a.length;b<c;b++)a[b]=this.formatContent_(a[b],","," ");b=null;M.utils.isNullOrEmpty(a);return b={docs:a}};M.plugin.Autocomplete.prototype.addEvents_=function(a){for(var b=0,c=a.length;b<c;b++)this.addEventSearchMunicipality_(a[b])};M.plugin.Autocomplete.prototype.addEventSearchMunicipality_=function(a){goog.events.listen(a,
goog.events.EventType.CLICK,function(b){this.searchMunicipality_(a.innerHTML,b)},!1,this)};M.plugin.Autocomplete.prototype.searchMunicipality_=function(a,b){this.busqMunicipio_=!0;this.search_(a.trim()+",",b)};M.plugin.Autocomplete.prototype.clickMunicipaly_=function(){this.busqMunicipioClick_=!0};M.plugin.Autocomplete.prototype.formatContent_=function(a,b,c){return a.replace(new RegExp(b,"g"),c)};M.plugin.Autocomplete.prototype.cancelSearch_=function(a){clearTimeout(this.timeoutKey_);this.minLength_<=
this.target_.value.length?goog.dom.classlist.add(this.target_,M.plugin.Autocomplete.SEARCHING_CLASS):goog.dom.classlist.remove(this.target_,M.plugin.Autocomplete.SEARCHING_CLASS)};M.plugin.Autocomplete.prototype.destroy=function(){this.map_=null};M.plugin.Autocomplete.CLASS="m-plugin-autocomplete";M.plugin.Autocomplete.SEARCHING_CLASS="searching";M.plugin.Autocomplete.RESULTAUTOCOMPLETE="resultautocomplete.html"})();goog.exportSymbol("M.plugin.Autocomplete",M.plugin.Autocomplete);goog.exportProperty(M.plugin.Autocomplete.prototype,"addTo",M.plugin.Autocomplete.prototype.addTo);goog.exportProperty(M.plugin.Autocomplete.prototype,"destroy",M.plugin.Autocomplete.prototype.destroy);goog.exportSymbol("M.plugin.Autocomplete.CLASS",M.plugin.Autocomplete.CLASS);goog.exportSymbol("M.plugin.Autocomplete.SEARCHING_CLASS",M.plugin.Autocomplete.SEARCHING_CLASS);
goog.exportSymbol("M.plugin.Autocomplete.RESULTAUTOCOMPLETE",M.plugin.Autocomplete.RESULTAUTOCOMPLETE); })(window.M);
